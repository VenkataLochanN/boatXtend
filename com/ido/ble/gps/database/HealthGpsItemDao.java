...
public class HealthGpsItemDao extends AbstractDao<HealthGpsItem, Long> {
    ...
    public static void createTable(Database database, boolean z) {
        database.execSQL("CREATE TABLE " + (z ? "IF NOT EXISTS " : "") + "\"HEALTH_GPS_ITEM\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"D_ID\" INTEGER NOT NULL ,\"LONGITUDE\" REAL,\"LATITUDE\" REAL,\"DATE\" INTEGER);");
    }
    ...
    public HealthGpsItem readEntity(Cursor cursor, int i) {
        ...
        int i3 = i + 2;
        Double dValueOf = cursor.isNull(i3) ? null : Double.valueOf(cursor.getDouble(i3));
        int i4 = i + 3;
        int i5 = i + 4;
        return new HealthGpsItem(lValueOf, j, dValueOf, cursor.isNull(i4) ? null : Double.valueOf(cursor.getDouble(i4)), cursor.isNull(i5) ? null : Long.valueOf(cursor.getLong(i5)));
    }
