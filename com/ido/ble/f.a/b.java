...
public class b {
    ...
    private static final String f4413b = "idoLib.db";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f4414c = "A*&DF90,Kudc123";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static b f4415d;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private DaoSession f4416a;
    ...
    private static class a extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(Database database, int i, int i2) {
            LogTool.d("DB_Helper", i + AppInfo.DELIM + i2);
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i != 4) {
    ...
    private long e() {
        ...
        if (bLEDeviceC == null) {
            ...
            String str2 = bLEDeviceC.mDeviceAddress;
    ...
    private void f() {
        a aVar = new a(e.a(), !TextUtils.isEmpty(CustomConfig.getConfig().getDatabaseName()) ? CustomConfig.getConfig().getDatabaseName() : f4413b, null);
        this.f4416a = (CustomConfig.getConfig().isEncryptedDBData() ? new DaoMaster(aVar.getEncryptedWritableDb(f4414c)) : new DaoMaster(aVar.getWritableDatabase())).newSession();
    }
    ...
    public void a() {
        DaoSession daoSession = this.f4416a;
        if (daoSession != null) {
            DaoMaster.dropAllTables(daoSession.getDatabase(), true);
            DaoMaster.createAllTables(this.f4416a.getDatabase(), true);
        }
    }
