...
public class b extends com.ido.ble.f.a.e.p.a implements com.ido.ble.f.a.d.b {
    ...
    public List<HealthBloodPressedItem> a(long j, int i, int i2) {
        ...
        Date dateA = a(i, i2);
        QueryBuilder<HealthBloodPressedItem> queryBuilder = b().queryBuilder();
        queryBuilder.where(queryBuilder.and(HealthBloodPressedItemDao.Properties.DId.eq(Long.valueOf(j)), HealthBloodPressedItemDao.Properties.Date.ge(dateB), HealthBloodPressedItemDao.Properties.Date.le(dateA)), new WhereCondition[0]);
        queryBuilder.orderDesc(HealthBloodPressedItemDao.Properties.Date);
        return queryBuilder.list();
    }
    ...
    public void a(long j, Date date, Date date2) {
        QueryBuilder<HealthBloodPressedItem> queryBuilder = b().queryBuilder();
        queryBuilder.where(queryBuilder.and(HealthBloodPressedItemDao.Properties.DId.eq(Long.valueOf(j)), HealthBloodPressedItemDao.Properties.Date.ge(date), HealthBloodPressedItemDao.Properties.Date.le(date2)), new WhereCondition[0]).buildDelete().executeDeleteWithoutDetachingEntities();
    }
    ...
    public List<HealthBloodPressedItem> b(long j, Date date, Date date2) {
        QueryBuilder<HealthBloodPressedItem> queryBuilder = b().queryBuilder();
        queryBuilder.where(queryBuilder.and(HealthBloodPressedItemDao.Properties.DId.eq(Long.valueOf(j)), HealthBloodPressedItemDao.Properties.Date.ge(date), HealthBloodPressedItemDao.Properties.Date.le(date2)), new WhereCondition[0]);
        queryBuilder.orderDesc(HealthBloodPressedItemDao.Properties.Date);
        return queryBuilder.list();
    }
