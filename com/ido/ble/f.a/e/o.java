...
public class o extends com.ido.ble.f.a.e.p.a implements com.ido.ble.f.a.d.e<HealthSwimming> {
    ...
    public List<HealthSwimming> a(long j, int i, int i2) {
        ...
        Date dateA = a(i, i2);
        QueryBuilder<HealthSwimming> queryBuilder = b().queryBuilder();
        queryBuilder.where(queryBuilder.and(HealthSwimmingDao.Properties.DId.eq(Long.valueOf(j)), HealthSwimmingDao.Properties.Date.ge(dateB), HealthSwimmingDao.Properties.Date.le(dateA)), new WhereCondition[0]);
        queryBuilder.orderDesc(HealthSwimmingDao.Properties.Date);
        return queryBuilder.list();
    }
    ...
    public void b(long j, HealthSwimming healthSwimming) {
        ...
        HealthSwimming healthSwimmingB = b(j, healthSwimming.getYear(), healthSwimming.getMonth(), healthSwimming.getDay(), healthSwimming.getHour(), healthSwimming.getMinute(), healthSwimming.getSecond());
        if (healthSwimmingB == null) {
            healthSwimming.setDId(j);
            b().insert(healthSwimming);
        } else {
            healthSwimming.setDataId(healthSwimmingB.getDataId());
            a(j, healthSwimming);
        }
    }
