...
public class a {
    public static void A() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to get DoNotDisturbPara");
        i.e();
    }

    public static void A0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] stop sync health data!");
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS == com.veryfit.multi.nativeprotocol.a.a(p.k())) {
            return;
        }
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] stop sync health data failed! so.lib check error.");
    }

    public static void B() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getExFunctionTables...");
        h.g();
    }
    ...
    public static void C() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to  getFirmwareAndBt3Version");
        i.f();
    }

    public static void C0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEto stop VoiceRecognize ");
        q.c();
    }

    public static void D() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getFlashBinInfo...");
        h.h();
    }

    public static void D0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] start to unbind...");
        if (!com.ido.ble.bluetooth.a.h()) {
            LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] not in connected state, use 'forceUnbind' ...");
            k();
            return;
        }
        int iB = d.b();
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS != com.veryfit.multi.nativeprotocol.a.a(iB)) {
            LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] unbind failed! so check error. error =" + iB);
            com.ido.ble.event.stat.one.c.j("error:" + iB);
            UnbindCallBack.a();
        }
    }

    public static void E() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getHIDInfo...");
        h.j();
    }
    ...
    public static void F() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getLiveData...");
        h.k();
    }
    ...
    public static void G() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getMacAddress...");
        h.l();
    }

    public static void H() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  getMenuList ");
        i.g();
    }

    public static void I() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getNoticeReminderSwitchStatus...");
        h.m();
    }
    ...
    public static void K() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to  getPressValue");
        i.h();
    }
    ...
    public static void M() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to getScreenBrightness");
        i.i();
    }

    public static void N() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to getSportThreeCircleGoal");
        i.j();
    }

    public static void O() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to getSupportSportInfoV3");
        i.k();
    }

    @Deprecated
    public static void P() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getTime...");
        h.p();
    }

    public static void Q() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to getUpHandGesture");
        i.l();
    }

    public static void R() {
        com.ido.ble.f.a.c.h().b();
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getUserFunctionTables...");
        h.q();
    }
    ...
    public static void T() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  getVoiceDefaultLang ");
        q.a();
    }

    public static void U() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to getWalkReminder");
        i.m();
    }

    public static void V() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  getWatchPlateList ");
        com.ido.ble.watch.custom.d.a();
    }

    public static void W() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  getWatchPlateScreenInfo ");
    ...
    public static void a() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] start cancelBind...");
        d.a();
    }

    public static void a(int i) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  getInfoFromDeviceByType, type= " + i);
        u.b("{}".getBytes(), i);
    }

    public static void a(int i, int i2) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] set health data offset, type=" + i + ", value=" + i2);
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS == com.veryfit.multi.nativeprotocol.a.a(p.a(i, i2))) {
            return;
        }
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] set health data offset failed! so.lib check error.");
    }
    ...
    public static void a(ActivitySwitch activitySwitch) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setActivitySwitch " + activitySwitch.toString());
        o.a(activitySwitch);
    }
    ...
    public static void a(AntiLostMode antiLostMode) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setAntiLostMode ," + antiLostMode.toString());
        o.a(antiLostMode);
    }
    ...
    public static void a(BindEncrypted bindEncrypted) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] start to setEncryptedData " + bindEncrypted.toString());
        int iA = d.a(bindEncrypted);
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS != com.veryfit.multi.nativeprotocol.a.a(iA)) {
            LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] bind failed! so check error. error =" + iA);
            BindCallBack.b();
        }
    }
    ...
    public static void a(BloodPressureAdjustPara bloodPressureAdjustPara) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setBloodPressureAdjustPara ," + bloodPressureAdjustPara.toString());
        o.a(bloodPressureAdjustPara);
    }

    public static void a(BloodPressureQueryAdjustResultPara bloodPressureQueryAdjustResultPara) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to queryBloodPressureAdjustResult ," + bloodPressureQueryAdjustResultPara.toString());
        o.a(bloodPressureQueryAdjustResultPara);
    }

    public static void a(BreatheTrain breatheTrain) {
        com.ido.ble.f.a.c.h().a(breatheTrain);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setBreatheTrain " + breatheTrain.toString());
        o.a(breatheTrain);
    }

    public static void a(CalorieAndDistanceGoal calorieAndDistanceGoal) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setCalorieAndDistanceGoal " + calorieAndDistanceGoal.toString());
    ...
    public static void a(DeviceLogClearPara deviceLogClearPara) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  clearDeviceLog " + deviceLogClearPara.toString());
    ...
    public static void a(DeviceUnreadReminder deviceUnreadReminder) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setDeviceUnreadReminder ," + deviceUnreadReminder.toString());
        o.a(deviceUnreadReminder);
    }

    public static void a(DialPlate dialPlate) {
        com.ido.ble.f.a.c.h().a(dialPlate);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setDialPlate ," + dialPlate.toString());
        o.a(dialPlate);
    }

    public static void a(DisplayMode displayMode) {
        com.ido.ble.f.a.c.h().a(displayMode);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setDisplayMode ," + displayMode.toString());
        o.a(displayMode);
    }

    public static void a(DrinkWaterReminder drinkWaterReminder) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setDrinkWaterReminder, =" + drinkWaterReminder.toString());
        com.ido.ble.f.a.c.h().a(drinkWaterReminder);
        o.a(drinkWaterReminder);
    }

    public static void a(FitnessGuidance fitnessGuidance) {
        com.ido.ble.f.a.f.a.c0().a(fitnessGuidance);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setFitnessGuidance ," + fitnessGuidance.toString());
        o.a(fitnessGuidance);
    }

    public static void a(Goal goal) {
        com.ido.ble.f.a.c.h().a(goal);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setGoal ," + goal.toString());
        o.a(goal);
    }

    public static void a(HandWearMode handWearMode) {
        com.ido.ble.f.a.c.h().a(handWearMode);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setHandMode ," + handWearMode.toString());
        o.a(handWearMode);
    }

    public static void a(HeartRateInterval heartRateInterval) {
        com.ido.ble.f.a.c.h().a(heartRateInterval);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setHeartRateInterval ," + heartRateInterval.toString());
    ...
    public static void a(HeartRateMeasureMode heartRateMeasureMode) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setHeartRateMeasureMode ," + heartRateMeasureMode.toString());
        o.a(heartRateMeasureMode);
    }

    public static void a(HeartRateMeasureModeV3 heartRateMeasureModeV3) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setHeartRateMeasureModeV3 ," + heartRateMeasureModeV3.toString());
        o.a(heartRateMeasureModeV3);
    }

    public static void a(HeartRateSmartMode heartRateSmartMode) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setHeartRateSmart, =" + heartRateSmartMode.toString());
        o.a(heartRateSmartMode);
    }

    public static void a(IconTransInformation iconTransInformation) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setTranSportIconInformation");
        o.a(iconTransInformation);
    }

    public static void a(IncomingCallInfo incomingCallInfo) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "setIncomingCallInfo " + incomingCallInfo);
        l.a(incomingCallInfo);
    }

    public static void a(LongSit longSit) {
        com.ido.ble.f.a.c.h().a(longSit);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setLongSit ," + longSit.toString());
        o.a(longSit);
    }

    public static void a(MedicineReminder medicineReminder) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setMedicineReminder, " + medicineReminder.toString());
    ...
    public static void a(MenstruationHistoricalData menstruationHistoricalData) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setMenstruationHistoricalData");
        o.a(menstruationHistoricalData);
    }

    public static void a(MenuList menuList) {
        com.ido.ble.f.a.c.h().a(menuList);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setMenuList " + menuList.toString());
        o.a(menuList);
    }

    public static void a(MusicControlInfo musicControlInfo) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setMusicControlInfo " + musicControlInfo.toString());
    ...
    public static void a(MusicOperate.MusicFile musicFile) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  addMusicFile, " + musicOperate.toString());
        j.a(musicOperate);
    }
    ...
    public static void a(MusicOperate.MusicFolder musicFolder) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  addMusicFolder, " + musicFolder.toString());
        j.a(musicOperate);
    }

    public static void a(NewMessageInfo newMessageInfo) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "setNewMessageDetailInfo :" + newMessageInfo.type);
    ...
    public static void a(NightTemperatureMonitoringPara nightTemperatureMonitoringPara) {
        com.ido.ble.f.a.f.a.c0().a(nightTemperatureMonitoringPara);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setNightTemperatureMonitoringPara ," + nightTemperatureMonitoringPara.toString());
        o.a(nightTemperatureMonitoringPara);
    }

    public static void a(NoisePara noisePara) {
        com.ido.ble.f.a.f.a.c0().a(noisePara);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setNoisePara, =" + noisePara.toString());
        o.a(noisePara);
    }

    public static void a(NotDisturbPara notDisturbPara) {
        com.ido.ble.f.a.c.h().a(notDisturbPara);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setNotDisturbPara ," + notDisturbPara.toString());
        o.a(notDisturbPara);
    }
    ...
    public static void a(NoticeReminderSwitchStatus noticeReminderSwitchStatus) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setNoticeReminderSwitchStatus ," + noticeReminderSwitchStatus.toString());
    ...
    public static void a(NotificationPara notificationPara) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "sendNotification ：" + notificationPara.toString());
    ...
    public static void a(PhoneVoice phoneVoice) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setPhoneVoice, " + phoneVoice.toString());
        o.a(phoneVoice);
    }

    public static void a(PressCalibration pressCalibration) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setPressCalibration");
        o.a(pressCalibration);
    }

    public static void a(PressureParam pressureParam) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setPressureParam " + pressureParam.toString());
        com.ido.ble.f.a.c.h().a(pressureParam);
        k.a(pressureParam);
    }

    public static void a(QuickReplyInfo quickReplyInfo) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setPhoneVoice, " + quickReplyInfo.toString());
        o.a(quickReplyInfo);
    }

    public static void a(QuickSportMode quickSportMode) {
        com.ido.ble.f.a.c.h().a(quickSportMode);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setQuickSportMode ," + quickSportMode.toString());
        o.a(quickSportMode);
    }

    public static void a(SPO2Param sPO2Param) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setSPO2Param " + sPO2Param.toString());
        com.ido.ble.f.a.c.h().a(sPO2Param);
        k.a(sPO2Param);
    }

    public static void a(ScheduleReminderSwitch scheduleReminderSwitch) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setScheduleReminderSwitch ," + scheduleReminderSwitch.toString());
        o.a(scheduleReminderSwitch);
    }

    public static void a(ScreenBrightness screenBrightness) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setScreenBrightness, =" + screenBrightness.toString());
    ...
    public static void a(ShortCut shortCut) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setShortCut ," + shortCut.toString());
        o.a(shortCut);
    }

    public static void a(SleepMonitoringPara sleepMonitoringPara) {
        com.ido.ble.f.a.f.a.c0().a(sleepMonitoringPara);
        o.a(sleepMonitoringPara);
    }

    public static void a(SportModeSort sportModeSort) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setSportModeSortInfo " + sportModeSort.toString());
        com.ido.ble.f.a.c.h().a(sportModeSort);
        k.a(sportModeSort);
    }

    public static void a(SportModeSortV3 sportModeSortV3) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setSportModeSortInfoV3 " + sportModeSortV3.toString());
        com.ido.ble.f.a.c.h().a(sportModeSortV3);
        o.a(sportModeSortV3);
    }

    public static void a(StopFindPhone stopFindPhone) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setStopFindPhone ," + stopFindPhone.toString());
        o.a(stopFindPhone);
    }
    ...
    public static void a(SystemTime systemTime) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setTime ," + systemTime.toString());
        o.a(systemTime);
    }

    public static void a(Units units) {
        com.ido.ble.f.a.c.h().a(units);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setUnit ," + units.toString());
        o.a(units);
    }
    ...
    public static void a(UpHandGesture upHandGesture) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setUpHandGesture ," + upHandGesture.toString());
        o.a(upHandGesture);
    }

    public static void a(UserInfo userInfo) {
        com.ido.ble.f.a.c.h().a(userInfo);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setUserInfo ," + userInfo.toString());
        UserInfo userInfoCloneNew = userInfo.cloneNew();
        userInfoCloneNew.weight = userInfoCloneNew.weight * 100;
        o.a(userInfoCloneNew);
        com.ido.ble.f.a.f.a.c0().a(userInfo);
    }
    ...
    public static void a(V3MessageNotice v3MessageNotice) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "setV3MessageNotice ：" + v3MessageNotice.evtType);
        l.a(v3MessageNotice);
    }

    public static void a(VoiceControlAlarm voiceControlAlarm) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  voiceControlAlarm " + voiceControlAlarm.toString());
        q.a(voiceControlAlarm);
    }

    public static void a(VoiceControlBrightnessLevel voiceControlBrightnessLevel) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  controlBrightnessLevel " + voiceControlBrightnessLevel.toString());
        q.a(voiceControlBrightnessLevel);
    }

    public static void a(VoiceControlFuncWithNoPara voiceControlFuncWithNoPara) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  controlFuncWithNoPara " + voiceControlFuncWithNoPara.toString());
        q.a(voiceControlFuncWithNoPara);
    }

    public static void a(VoiceControlMusic voiceControlMusic) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  controlMusic " + voiceControlMusic.toString());
        q.a(voiceControlMusic);
    }

    public static void a(VoiceControlReminder voiceControlReminder) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  voiceControlReminder " + voiceControlReminder.toString());
        q.a(voiceControlReminder);
    }

    public static void a(VoiceControlSports voiceControlSports) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  controlSports " + voiceControlSports.toString());
        q.a(voiceControlSports);
    }

    public static void a(VoiceControlSwitchFunc voiceControlSwitchFunc) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  controlSwitchFunc " + voiceControlSwitchFunc.toString());
        q.a(voiceControlSwitchFunc);
    }

    public static void a(VoiceCountDown voiceCountDown) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  controlCountDown " + voiceCountDown.toString());
        q.a(voiceCountDown);
    }

    public static void a(VoiceLoginState voiceLoginState) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  setVoiceLoginState " + voiceLoginState.toString());
        q.a(voiceLoginState);
    }

    public static void a(VoiceNotifyState voiceNotifyState) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  setVoiceNotifyState " + voiceNotifyState.toString());
        q.a(voiceNotifyState);
    }

    public static void a(VoiceRecognizeState voiceRecognizeState) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  setVoiceRecognizeState " + voiceRecognizeState.toString());
        q.a(voiceRecognizeState);
    }

    public static void a(VoiceStopWatch voiceStopWatch) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to  controlStopWatch " + voiceStopWatch.toString());
        q.a(voiceStopWatch);
    }

    public static void a(VoiceToText voiceToText) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setVoiceToText, " + voiceToText.toString());
        o.a(voiceToText);
    }

    public static void a(WalkRealTimeReminder walkRealTimeReminder) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setWalkRealTimeReminder ," + walkRealTimeReminder.toString());
        o.a(walkRealTimeReminder);
    }

    public static void a(WalkReminder walkReminder) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setWalkReminder " + walkReminder.toString());
        com.ido.ble.f.a.c.h().a(walkReminder);
        o.a(walkReminder);
    }

    public static void a(WallpaperFileCreateConfig wallpaperFileCreateConfig) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  createPlateWallpaperFile " + wallpaperFileCreateConfig.toString());
        b(5500, com.ido.ble.common.k.a(wallpaperFileCreateConfig));
    }

    public static void a(WashHandReminder washHandReminder) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setWashHandReminder, " + washHandReminder.toString());
        o.a(washHandReminder);
    }

    public static void a(WatchDialOrder watchDialOrder) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setWatchDialOrder");
        o.a(watchDialOrder);
    }
    ...
    public static void a(PhotoWallpaperOperation.SetParams setParams) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  photoWallpaperOperate " + setParams.toString());
        com.ido.ble.watch.custom.b.a(setParams);
    }

    public static void a(WatchPlateFileMakeConfig watchPlateFileMakeConfig) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  makeWatchPlateFile " + watchPlateFileMakeConfig.toString());
        com.ido.ble.watch.custom.d.a(watchPlateFileMakeConfig);
    }

    private static void a(WatchPlateOperation watchPlateOperation) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  watchPlateOperate " + watchPlateOperation.toString());
    ...
    public static void a(List<FrequentContactsV3> list) {
        ...
        add.items = new ArrayList();
        add.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to add FrequentContactsV3 ," + new Gson().toJson(add));
        j.a(add);
    }
    ...
    public static void a(List<Integer> list, int i) {
        ...
        sport100TypeSort.items_set = new ArrayList();
        sport100TypeSort.items_set.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  setSport100TypeSort, " + sport100TypeSort.toString());
    ...
    public static void a(List<MessageNotifyState> list, int i, int i2) {
        ...
        add.items = new ArrayList();
        add.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to add MessageNotifyState ," + new Gson().toJson(add));
        j.a(add);
    }

    public static void a(boolean z) {
        com.ido.ble.f.a.c.h().a(z);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setFindPhoneSwitch ," + z);
        o.a(z);
    }
    ...
    public static void a(int[] iArr) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] start to setBindAuth " + bindAuth.toString());
        com.ido.ble.bluetooth.a.g(com.ido.ble.common.k.a(bindAuth));
        int iA = d.a(bindAuth);
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS != com.veryfit.multi.nativeprotocol.a.a(iA)) {
            LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] bind failed! so check error. error =" + iA);
            com.ido.ble.event.stat.one.c.a("error:" + iA);
            BindCallBack.b();
        }
    }

    public static void a0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "missedInComingCall ");
        l.a();
    }

    public static void b() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  clearDeviceHeatLog ");
    ...
    public static void b(int i) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  querySportSubItemParaSort, " + sportSubItemParaSort.toString());
        j.a(sportSubItemParaSort);
    }

    public static void b(int i, String str) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  setParaToDeviceByTypeAndJson, type= " + i + ",jsonPara=" + str);
        u.b(com.ido.ble.common.c.b(str), i);
    }
    ...
    public static void b(MusicOperate.MusicFile musicFile) {
        ...
        musicOperate.music_items = musicFile;
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  deleteMusicFile, " + musicFile.toString());
        j.a(musicOperate);
    }
    ...
    public static void b(MusicOperate.MusicFolder musicFolder) {
        ...
        musicOperate.folder_items = musicFolder;
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  deleteMusicFolder, " + musicFolder.toString());
        j.a(musicOperate);
    }

    public static void b(String str) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] start to forceUnbind..." + str);
        com.ido.ble.bluetooth.b.a(str);
        UnbindCallBack.b();
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] force unbind ok!" + str);
    }
    ...
    public static void b(List<ScheduleReminderV3> list) {
        ...
        add.items = new ArrayList();
        add.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to add ScheduleReminderV3 ," + new Gson().toJson(add));
        j.a(add);
    }
    ...
    public static void b(List<MessageNotifyState> list, int i, int i2) {
        ...
        modify.items = new ArrayList();
        modify.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to modify MessageNotifyState ," + new Gson().toJson(modify));
        j.a(modify);
    }

    public static void b(boolean z) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] setIsAutoSyncConfigIfReboot, " + z);
        o.b(z);
    }
    ...
    public static void c(int i) {
        u.a(com.veryfit.multi.nativeprotocol.b.k5, i, 0, 0);
    }
    ...
    public static void c(MusicOperate.MusicFolder musicFolder) {
        ...
        musicOperate.folder_items = musicFolder;
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  moveMusicIntoFolder, " + musicOperate.toString());
        j.a(musicOperate);
    }
    ...
    public static void c(List<FrequentContactsV3> list) {
        ...
        delete.items = new ArrayList();
        delete.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to delete FrequentContactsV3 ," + new Gson().toJson(delete));
        j.a(delete);
    }
    ...
    public static void c(List<Integer> list, int i, int i2) {
        ...
        sportSubItemParaSort.items = new ArrayList();
        sportSubItemParaSort.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  setSportSubItemParaSort, " + sportSubItemParaSort.toString());
        j.b(sportSubItemParaSort);
    }

    public static void c(boolean z) {
        com.ido.ble.f.a.c.h().b(z);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setMusicSwitch ," + z);
        o.c(z);
        com.ido.ble.f.a.f.a.c0().b(z);
    }

    public static void c0() {
        FrequentContactsV3CmdParaWrapper.Query query = new FrequentContactsV3CmdParaWrapper.Query();
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to query FrequentContactsV3 ," + new Gson().toJson(query));
        j.a(query);
    }
    ...
    public static void d(int i) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  setParaToDeviceByType, type= " + i);
        u.b("{}".getBytes(), i);
    }
    ...
    public static void d(MusicOperate.MusicFolder musicFolder) {
        ...
        musicOperate.folder_items = musicFolder;
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  removeMusicFromFolder, " + musicOperate.toString());
        j.a(musicOperate);
    }

    public static void d(String str) {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setWeatherCityName, " + str);
        o.a(str);
    }
    ...
    public static void d(List<ScheduleReminderV3> list) {
        ...
        delete.items = new ArrayList();
        delete.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to delete ScheduleReminderV3 ," + new Gson().toJson(delete));
        j.a(delete);
    }

    public static void d(boolean z) {
        com.ido.ble.f.a.c.h().c(z);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setOneKeySOSSwitch ," + z);
        o.d(z);
    }

    public static void d0() {
        MessageNotifyStateCmdParaWrapper.Query query = new MessageNotifyStateCmdParaWrapper.Query();
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to query MessageNotifyState ," + new Gson().toJson(query));
        j.a(query);
    }
    ...
    public static void e(MusicOperate.MusicFolder musicFolder) {
        ...
        musicOperate.folder_items = musicFolder;
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  updateMusicFolder, " + musicFolder.toString());
        j.a(musicOperate);
    }
    ...
    public static void e(List<FrequentContactsV3> list) {
        ...
        modify.items = new ArrayList();
        modify.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to modify FrequentContactsV3 ," + new Gson().toJson(modify));
        j.a(modify);
    }
    ...
    public static void e(boolean z) {
        ...
        screenBrightnessO.mode = z ? 1 : 0;
        screenBrightnessO.autoAdjustNight = 2;
        screenBrightnessO.opera = 1;
        a(screenBrightnessO);
    }

    public static void e0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  queryMusicAndFolderInfo");
        j.a();
    }
    ...
    public static void f(List<ScheduleReminderV3> list) {
        ...
        modify.items = new ArrayList();
        modify.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to modify ScheduleReminderV3 ," + new Gson().toJson(modify));
        j.a(modify);
    }

    public static void f(boolean z) {
        com.ido.ble.f.a.c.h().d(z);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setWeatherSwitch ," + z);
        o.e(z);
    }

    public static void f0() {
        ScheduleReminderV3CmdParaWrapper.Query query = new ScheduleReminderV3CmdParaWrapper.Query();
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to query ScheduleReminderV3 ," + new Gson().toJson(query));
        j.a(query);
    }
    ...
    public static void g(List<Alarm> list) {
        ...
        if (list == null || list.size() == 0) {
            ...
            Map<Integer, Alarm> mapF = com.ido.ble.f.a.f.a.c0().f();
            for (Alarm alarm2 : list) {
                if (mapF.containsKey(Integer.valueOf(alarm2.getAlarmId()))) {
                    mapF.remove(Integer.valueOf(alarm2.getAlarmId()));
                }
            }
            if (mapF.size() != 0) {
                Iterator<Map.Entry<Integer, Alarm>> it = mapF.entrySet().iterator();
                while (it.hasNext()) {
                ...
                LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] remove Alarms ," + new Gson().toJson(mapF));
            }
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setAlarm ," + new Gson().toJson(list));
    ...
    public static void g0() {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to get querySmallQuickModule ," + new Gson().toJson(query));
        j.a(query);
    }
    ...
    public static void h(List<AlarmV3> list) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to set AlarmsV3 ," + new Gson().toJson(alarmSet));
        o.a(alarmSet);
    }
    ...
    public static void h0() {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[OPERATE_PARA] start to  querySport100TypeSort, " + sport100TypeSort.toString());
    ...
    public static void i(List<FrequentContactsV3> list) {
        ...
        set.items.addAll(list);
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to set FrequentContactsV3 ," + new Gson().toJson(set));
        j.a(set);
    }

    public static void i0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "to reboot");
        m.a();
    }
    ...
    public static void j(List<SmallQuickModule> list) {
        ...
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to addSmallQuickModule ," + new Gson().toJson(set));
        j.a(set);
    }

    public static void j0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] start to send bind cmd...");
        ...
        int iA = d.a(bindPara);
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS != com.veryfit.multi.nativeprotocol.a.a(iA)) {
            LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] start to send bind cmd failed! .so check error. error =" + iA);
            com.ido.ble.event.stat.one.c.a("error:" + iA);
            BindCallBack.b();
        }
    }
    ...
    public static void k() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] start to forceUnbind...");
        com.ido.ble.bluetooth.b.b();
        UnbindCallBack.b();
        LogTool.d(com.ido.ble.logs.a.f4633a, "[BIND_UNBIND] force unbind ok!");
    }

    public static void k(List<WorldTime.Item> list) {
        WorldTime worldTime = new WorldTime();
        worldTime.items = new ArrayList<>();
        worldTime.items.addAll(list);
        worldTime.items_num = list.size();
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to set worldTime, =" + worldTime.toString());
        o.a(worldTime);
    }

    public static void k0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to setOneKeyReset");
        o.a();
    }

    public static void l() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getActivityCount...");
        h.a();
    }

    public static void l0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SET_PARA] start to  setRestoreFactory ");
        o.b();
    }

    public static void m() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to getActivitySwitch");
        i.a();
    }

    public static void m0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "setStopInComingCall ");
        l.b();
    }
    ...
    public static void n() {
        ...
        alarmGet.flag = 0;
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_PARA] start to get AlarmsV3 ," + new Gson().toJson(alarmGet));
        i.a(alarmGet);
    }
    ...
    public static void o() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to  getAllHealthMonitorSwitch");
        i.b();
    }
    ...
    public static void p() {
        com.ido.ble.f.a.c.h().b();
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getBasicInfo...");
        h.b();
    }
    ...
    public static void q() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getBatteryInfo...");
        h.c();
    }
    ...
    public static void r0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] start sync activity data...");
        int iE = p.e();
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS == com.veryfit.multi.nativeprotocol.a.a(iE)) {
            SyncCallBack.b();
            return;
        }
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] start sync activity data failed! so.lib check error.");
        com.ido.ble.event.stat.one.c.a("sync_activity", "error:" + iE);
        SyncCallBack.a();
    }

    public static void s() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to  getBtA2dpHfpStatus");
        i.c();
    }

    public static void s0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] start sync config...");
        int iF = p.f();
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS == com.veryfit.multi.nativeprotocol.a.a(iF)) {
            SyncCallBack.f();
            return;
        }
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] start sync config failed! so check error.");
        com.ido.ble.event.stat.one.c.a("sync_config", "error:" + iF);
        SyncCallBack.e();
    }

    public static void t() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getCanDownloadLangInfo...");
        h.d();
    }

    public static void t0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] start sync health data...");
        com.ido.ble.common.g.b();
        int iG = p.g();
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS == com.veryfit.multi.nativeprotocol.a.a(iG)) {
            SyncCallBack.j();
            return;
        }
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] start sync health data failed! so.lib check error.");
        com.ido.ble.event.stat.one.c.a("sync_health", "error:" + iG);
        SyncCallBack.i();
    }

    public static void u() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getCanDownloadLangInfoV3...");
        h.e();
    }

    public static int u0() {
        int iH = p.h();
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS == com.veryfit.multi.nativeprotocol.a.a(iH)) {
            SyncV3CallBack.onSyncV3HealthStart();
        } else {
            LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] start sync v3 data failed! so.lib check error.");
    ...
    public static void v() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to  getContactReceiveTime");
        i.d();
    }

    public static void v0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "IDO_VOICEstart to VoiceRecognize ");
        q.b();
    }
    ...
    public static void x() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  getDeviceHeatLog ");
        e.a();
    }
    ...
    public static void y() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[GET_INFO] start to getDeviceSummarySoftVersionInfo...");
        h.f();
    }

    public static void y0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] stop sync activity data!");
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS == com.veryfit.multi.nativeprotocol.a.a(p.i())) {
            return;
        }
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] stop sync activity data failed! so.lib check error.");
    }

    public static void z() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[IDO_WATCH_PLATE] start to  getDialPlateParam ");
        com.ido.ble.watch.custom.d.b();
    }

    public static void z0() {
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] stop sync config!");
        int iJ = p.j();
        Protocol.IS_SYNC_CONFIG = false;
        if (com.veryfit.multi.nativeprotocol.a.SUCCESS == com.veryfit.multi.nativeprotocol.a.a(iJ)) {
            return;
        }
        LogTool.d(com.ido.ble.logs.a.f4633a, "[SYNC_DATA] stop sync config failed! so.lib check error.");
    }
}