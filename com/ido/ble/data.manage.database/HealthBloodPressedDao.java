...
public class HealthBloodPressedDao extends AbstractDao<HealthBloodPressed, Long> {
    ...
    public static class Properties {
        ...
        public static final Property Max_bp = new Property(5, Integer.TYPE, "max_bp", false, "MAX_BP");
        public static final Property Minute_offset = new Property(6, Integer.TYPE, "minute_offset", false, "MINUTE_OFFSET");
        public static final Property Sleep_avg_bp = new Property(7, Integer.TYPE, "sleep_avg_bp", false, "SLEEP_AVG_BP");
    ...
    public HealthBloodPressed readEntity(Cursor cursor, int i) {
        ...
        int i9 = i + 8;
        return new HealthBloodPressed(lValueOf, j, i3, i4, i5, i6, i7, i8, cursor.isNull(i9) ? null : new Date(cursor.getLong(i9)));
    }
