...
public class OperateCallBack {
    ...
    public static final void onAddFolder(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.10
            @Override // java.lang.Runnable
            public void run() {
                Iterator<IMusicCallBack> it = b.K().u().iterator();
                while (it.hasNext()) {
                    it.next().onAddFolder(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onAddMusic(final OperateType operateType, final Boolean bool, final int i) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.8
            @Override // java.lang.Runnable
            public void run() {
                Iterator<IMusicCallBack> it = b.K().u().iterator();
                while (it.hasNext()) {
                    it.next().onAddMusic(operateType, bool.booleanValue(), i);
                }
            }
        });
    }
    ...
    public static final void onAddResult(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.2
            @Override // java.lang.Runnable
            public void run() {
                Iterator<ICallBack> it = b.K().t().iterator();
                while (it.hasNext()) {
                    it.next().onAddResult(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onDeleteFolder(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.9
            @Override // java.lang.Runnable
            public void run() {
                Iterator<IMusicCallBack> it = b.K().u().iterator();
                while (it.hasNext()) {
                    it.next().onDeleteFolder(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onDeleteFolderMusic(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.13
            @Override // java.lang.Runnable
            public void run() {
                Iterator<IMusicCallBack> it = b.K().u().iterator();
                while (it.hasNext()) {
                    it.next().onDeleteFolderMusic(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onDeleteMusic(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.7
            @Override // java.lang.Runnable
            public void run() {
                Iterator<IMusicCallBack> it = b.K().u().iterator();
                while (it.hasNext()) {
                    it.next().onDeleteMusic(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onDeleteResult(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.3
            @Override // java.lang.Runnable
            public void run() {
                Iterator<ICallBack> it = b.K().t().iterator();
                while (it.hasNext()) {
                    it.next().onDeleteResult(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onImportFolder(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.12
            @Override // java.lang.Runnable
            public void run() {
                Iterator<IMusicCallBack> it = b.K().u().iterator();
                while (it.hasNext()) {
                    it.next().onImportFolder(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onInvalid(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.6
            @Override // java.lang.Runnable
            public void run() {
                Iterator<IMusicCallBack> it = b.K().u().iterator();
                while (it.hasNext()) {
                    it.next().onInvalid(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onModifyFolder(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.11
            @Override // java.lang.Runnable
            public void run() {
                Iterator<IMusicCallBack> it = b.K().u().iterator();
                while (it.hasNext()) {
                    it.next().onModifyFolder(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onModifyResult(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.4
            @Override // java.lang.Runnable
            public void run() {
                Iterator<ICallBack> it = b.K().t().iterator();
                while (it.hasNext()) {
                    it.next().onModifyResult(operateType, bool.booleanValue());
                }
            }
        });
    }
    ...
    public static final void onQueryResult(final OperateType operateType, final Object obj) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.5
            @Override // java.lang.Runnable
            public void run() {
                Iterator<ICallBack> it = b.K().t().iterator();
                while (it.hasNext()) {
                    it.next().onQueryResult(operateType, obj);
                }
            }
        });
    }
    ...
    public static final void onSetResult(final OperateType operateType, final Boolean bool) {
        b.K().a(new Runnable() { // from class: com.ido.ble.callback.OperateCallBack.1
            @Override // java.lang.Runnable
            public void run() {
                Iterator<ICallBack> it = b.K().t().iterator();
                while (it.hasNext()) {
                    it.next().onSetResult(operateType, bool.booleanValue());
                }
            }
        });
    }
