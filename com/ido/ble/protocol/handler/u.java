...
public class u {
    ...
    public static void a(byte[] bArr) {
        int iReceiveDatafromBle = Protocol.getInstance().ReceiveDatafromBle(bArr);
        if (com.veryfit.multi.nativeprotocol.a.a(iReceiveDatafromBle) != com.veryfit.multi.nativeprotocol.a.SUCCESS) {
            LogTool.b("", "[] failed, error = " + com.veryfit.multi.nativeprotocol.a.a(iReceiveDatafromBle));
        }
    }
    ...
    public static void b(byte[] bArr) {
        int iReceiveDatafromSPP = Protocol.getInstance().ReceiveDatafromSPP(bArr);
        if (com.veryfit.multi.nativeprotocol.a.a(iReceiveDatafromSPP) != com.veryfit.multi.nativeprotocol.a.SUCCESS) {
            LogTool.b("", "[] failed, error = " + com.veryfit.multi.nativeprotocol.a.a(iReceiveDatafromSPP));
        }
    }
    ...
    public static void m() {
        Protocol.getInstance().WriteJsonData("{}".getBytes(), com.veryfit.multi.nativeprotocol.b.Z3);
    }
