...
final class a {
    ...
    private static void a(int i, AppControlDeviceCallBack.AppControlType appControlType) {
        AppControlDeviceCallBack.a(Boolean.valueOf(i == 0), appControlType);
    }
    ...
    private static void a(byte[] bArr) {
        BloodPressureMeasureCallBack.a((BloodPressureMeasureDeviceReplyData) new Gson().fromJson(com.ido.ble.common.c.d(bArr), BloodPressureMeasureDeviceReplyData.class));
    }
