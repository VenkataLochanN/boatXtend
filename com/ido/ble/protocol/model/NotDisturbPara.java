...
public class NotDisturbPara implements Serializable {
    ...
    public String toString() {
        return "NotDisturbPara{onOFf=" + this.onOFf + ", startHour=" + this.startHour + ", startMinute=" + this.startMinute + ", endHour=" + this.endHour + ", endMinute=" + this.endMinute + ", haveTimeRange=" + this.haveTimeRange + ", weeks=" + Arrays.toString(this.weeks) + ", weekRepeat=" + this.weekRepeat + ", noontimeRestOnOff=" + this.noontimeRestOnOff + ", noontimeRestStartHour=" + this.noontimeRestStartHour + ", noontimeRestStartMinute=" + this.noontimeRestStartMinute + ", noontimeRestEndHour=" + this.noontimeRestEndHour + ", noontimeRestEndMinute=" + this.noontimeRestEndMinute + '}';
    }
}