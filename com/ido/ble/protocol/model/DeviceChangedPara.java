...
public class DeviceChangedPara {
    ...
    public String toString() {
        return "DeviceChangedPara{doNotDisturb=" + this.doNotDisturb + ", dataType=" + this.dataType + ", msg_type=" + this.msg_type + ", msg_ID=" + this.msg_ID + ", msg_notice=" + this.msg_notice + ", errorIndex=" + this.errorIndex + ", notifyType=" + this.notifyType + '}';
    }
}