...
public class BatteryInfo implements Serializable {
    ...
    public String toString() {
        return "BatteryInfo{voltage=" + this.voltage + ", status=" + this.status + ", level=" + this.level + ", lastChargingYear=" + this.lastChargingYear + ", lastChargingMonth=" + this.lastChargingMonth + ", lastChargingDay=" + this.lastChargingDay + ", lastChargingHour=" + this.lastChargingHour + ", lastChargingMinute=" + this.lastChargingMinute + ", lastChargingSecond=" + this.lastChargingSecond + '}';
    }
}