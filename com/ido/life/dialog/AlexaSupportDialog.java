...
public class AlexaSupportDialog extends BaseDialogFragment {
    ...
    protected int getLayoutResId() {
        return R.layout.dialog_bind_alexa;
    }
    ...
    public static AlexaSupportDialog newInstance(String str, String str2, String str3, boolean z) {
        Bundle bundle = new Bundle();
        bundle.putString(MESSAGE, str);
        bundle.putString(TEXT_CONFIRM, str2);
        bundle.putString(TEXT_CANCEL, str3);
        bundle.putBoolean(SHOW_CANCEL, z);
        AlexaSupportDialog alexaSupportDialog = new AlexaSupportDialog();
        alexaSupportDialog.setArguments(bundle);
        alexaSupportDialog.setStyle(1, 2131886083);
        return alexaSupportDialog;
    }

    public static AlexaSupportDialog newInstance(String str, String str2, String str3, boolean z, boolean z2) {
        Bundle bundle = new Bundle();
        bundle.putString(MESSAGE, str);
        bundle.putString(TEXT_CONFIRM, str2);
        bundle.putString(TEXT_CANCEL, str3);
        ...
        AlexaSupportDialog alexaSupportDialog = new AlexaSupportDialog();
        alexaSupportDialog.setArguments(bundle);
        alexaSupportDialog.setCancelable(z2);
        alexaSupportDialog.setStyle(1, 2131886083);
        return alexaSupportDialog;
    }

    public static AlexaSupportDialog newInstance(String str, String str2, String str3, boolean z, boolean z2, boolean z3) {
        Bundle bundle = new Bundle();
        bundle.putString(MESSAGE, str);
        bundle.putString(TEXT_CONFIRM, str2);
        bundle.putString(TEXT_CANCEL, str3);
    ...
    public AlexaSupportDialog setOnConfirmListener(View.OnClickListener onClickListener) {
        this.mConfirmListener = onClickListener;
        return this;
    }

    public AlexaSupportDialog setCancelListener(View.OnClickListener onClickListener) {
        this.mCancelListener = onClickListener;
        return this;
    }

    @OnClick({R.id.tv_to_alexa})
