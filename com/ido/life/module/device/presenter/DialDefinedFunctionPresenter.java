...
public class DialDefinedFunctionPresenter extends BaseDialPresenter<DialDefinedView> implements DownloadManager.DownloadListener {
    ...
    private Runnable mSwitchDialRunnable = new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$-h_ErGZ3o7bX6KMsyV80s1InK7c
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.lambda$new$2$DialDefinedFunctionPresenter();
        }
    };
    private Runnable mDialRemoveRunnable = new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$g3Lzcg4R8t1HQEn-3JT0r1MiO1c
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.lambda$new$3$DialDefinedFunctionPresenter();
        }
    };

    /* JADX INFO: renamed from: com.ido.life.module.device.presenter.DialDefinedFunctionPresenter$1, reason: invalid class name */
    class AnonymousClass1 implements IconTransmitterListener {
        ...
        public void onTransferSuccess(int i, int i2) {
            if (i == 7) {
                ...
                DialDefinedFunctionPresenter dialDefinedFunctionPresenter = DialDefinedFunctionPresenter.this;
                dialDefinedFunctionPresenter.isSetting = false;
                dialDefinedFunctionPresenter.getInstalledDialInfo();
                DialDefinedFunctionPresenter.this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$1$Z3ZE2xVACliYoxfYbJat60bQ6VU
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onTransferSuccess$0$DialDefinedFunctionPresenter$1();
                    }
                });
            }
        }
        ...
        public void onTransferProgress(int i, int i2, final int i3) {
            if (i == 7) {
                ...
                DialDefinedFunctionPresenter.this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$1$Byd2tY7Mcc4IwP2JUI7qV-aOgHs
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onTransferProgress$1$DialDefinedFunctionPresenter$1(i3);
                    }
                });
                if (i3 >= 100) {
        ...
        public void onTransferStart(int i, int i2) {
            if (i == 7) {
                ...
                DialDefinedFunctionPresenter.this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$1$JEt_DLDCyvt1gNSIu9Ygb1ADc9k
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onTransferStart$2$DialDefinedFunctionPresenter$1();
                    }
                });
            }
        }
    ...
    public void onFailed(int i) {
        ...
        if (i == DIAL_INSTALL_FAIL_NOT_MEMORY) {
            this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$c7YwHWC0qZuB2WHIvMfnx1i3HPE
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onFailed$0$DialDefinedFunctionPresenter();
                }
            });
            return;
        }
        ...
        this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$7HBkC9NTbq6PchqmDywzOHMd7_E
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onFailed$1$DialDefinedFunctionPresenter();
            }
        });
    }
    ...
    public /* synthetic */ void lambda$new$2$DialDefinedFunctionPresenter() {
        if (this.isSetting) {
            saveDialLog("~~~~~~~~~切换表盘超时~~~~~~~~~");
    ...
    public void getDefinedEntity(Context context, String str) {
        File file = new File(FileDialDefinedUtil.jsonDirFunctionAppFile(context, getDeviceInfo().mDeviceId, str));
        ...
        if (isAttachView()) {
            try {
                ...
                ((DialDefinedView) getView()).getDefinedFuctionEntity((DialDefinedFunctionEntity) new Gson().fromJson(str2, DialDefinedFunctionEntity.class));
    ...
    */
    public void saveDialDefined(android.content.Context r27, com.ido.life.data.api.entity.MyDialListEntity.DialInfo r28, com.ido.life.data.api.entity.DialDefinedFunctionEntity r29, int r30, int r31, android.view.View r32, int r33) {
        /*
    ...
    /* JADX INFO: renamed from: com.ido.life.module.device.presenter.DialDefinedFunctionPresenter$2, reason: invalid class name */
    class AnonymousClass2 implements DeviceManager.OnDeviceCallback<Boolean> {
        ...
        public void onSuccess(Boolean bool) {
            ...
            DialDefinedFunctionPresenter.this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$2$hYKjO-rw8XclCDD1rgMmmwbBj7c
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onSuccess$0$DialDefinedFunctionPresenter$2();
                }
            });
        ...
        public void onFailed(int i, String str) {
            ...
            DialDefinedFunctionPresenter dialDefinedFunctionPresenter = DialDefinedFunctionPresenter.this;
            dialDefinedFunctionPresenter.isSetting = false;
            ((DialDefinedView) dialDefinedFunctionPresenter.getView()).onDialInstallFailed();
        }
    }
    ...
    /* JADX INFO: renamed from: com.ido.life.module.device.presenter.DialDefinedFunctionPresenter$3, reason: invalid class name */
        ...
        public void onSuccess(Boolean bool) {
            if (bool.booleanValue()) {
                if (DialDefinedFunctionPresenter.this.isDownDial) {
                    DialDefinedFunctionPresenter dialDefinedFunctionPresenter = DialDefinedFunctionPresenter.this;
                    dialDefinedFunctionPresenter.isSetting = false;
                    dialDefinedFunctionPresenter.isDownDial = false;
                    DialDefinedFunctionPresenter.this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$3$YDl10gcQsbyc97n7oQjPrA2DDjg
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onSuccess$0$DialDefinedFunctionPresenter$3();
                        }
                    });
                }
                EventBusHelper.post(400);
            ...
            DialDefinedFunctionPresenter dialDefinedFunctionPresenter2 = DialDefinedFunctionPresenter.this;
            dialDefinedFunctionPresenter2.isSetting = false;
            ((DialDefinedView) dialDefinedFunctionPresenter2.getView()).onDialInstallFailed();
        }
    ...
    private void deleteDialFromServer() {
        DeviceManager.deleteDial(getDeviceInfo(), this.mDialId, new DeviceManager.OnDeviceCallback<Boolean>() { // from class: com.ido.life.module.device.presenter.DialDefinedFunctionPresenter.4
            ...
            public void onFailed(int i, String str) {
                DialDefinedFunctionPresenter dialDefinedFunctionPresenter = DialDefinedFunctionPresenter.this;
                dialDefinedFunctionPresenter.isSetting = false;
                if (dialDefinedFunctionPresenter.isAttachView()) {
    ...
    public void onDownloadStart() {
        ...
        this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$Ai-swc_q66GIRQKdS8fmtxqEF0k
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onDownloadStart$4$DialDefinedFunctionPresenter();
            }
        });
    }

    public /* synthetic */ void lambda$onDownloadStart$4$DialDefinedFunctionPresenter() {
        if (isAttachView()) {
    ...
    public void onDownloadProgress(final int i) {
        ...
        this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$d3Fvl8DPc7-qANExbSyjiQbKs_U
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onDownloadProgress$5$DialDefinedFunctionPresenter(i);
            }
        });
    }

    public /* synthetic */ void lambda$onDownloadProgress$5$DialDefinedFunctionPresenter(int i) {
        if (isAttachView()) {
    ...
    public void onDownloadFinish(String str) {
        ...
        this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$dLyVYv9ZejKXLrlQ24XLaidPp_w
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onDownloadFinish$6$DialDefinedFunctionPresenter();
            }
        });
    }

    public /* synthetic */ void lambda$onDownloadFinish$6$DialDefinedFunctionPresenter() {
        if (isAttachView()) {
    ...
    public void setDialData(String str) {
        saveDialLog("~~~~~~~~~onDownloadFinish~~~~~~~~~" + str);
        this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$vPpQfPheoB4-Vo4WUbDGZoHA80k
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setDialData$7$DialDefinedFunctionPresenter();
            }
        });
    ...
    public /* synthetic */ void lambda$setDialData$7$DialDefinedFunctionPresenter() {
        if (isAttachView()) {
            ((DialDefinedView) getView()).onProgress(1, 100);
        }
    }
    ...
    public void onDownloadFailed(int i, String str) {
        ...
        this.isSetting = false;
        this.mHandler.post(new Runnable() { // from class: com.ido.life.module.device.presenter.-$$Lambda$DialDefinedFunctionPresenter$RK7zUmsUsQlFhyUy5dOV0ZXzqtU
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onDownloadFailed$8$DialDefinedFunctionPresenter();
            }
        });
    }

    public /* synthetic */ void lambda$onDownloadFailed$8$DialDefinedFunctionPresenter() {
        if (isAttachView()) {
            ((DialDefinedView) getView()).onDownloadFailed();
        }
    }
