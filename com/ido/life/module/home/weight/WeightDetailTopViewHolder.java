...
public class WeightDetailTopViewHolder extends BaseDetailTopViewHolder {
    ...
    public WeightDetailTopViewHolder(View view) {
        super(view);
        setDefaultValue();
        refreshLanguage();
    }
    ...
    public void refreshLanguage() {
        ...
        if (RunTimeUtil.getInstance().getUnitSet() == 1) {
            this.mTvUnit.setText(LanguageUtil.getLanguageText(R.string.weight_kg_unit_short));
        } else {
            this.mTvUnit.setText(LanguageUtil.getLanguageText(R.string.weight_pound_unit_short));
        }
    }
