...
public class RunBottomView extends FrameLayout {
    private String data;
    ...
    public RunBottomView(Context context) {
        this(context, null);
    }
    ...
    public RunBottomView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void initType(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.RunBottomView);
        this.mTataTextSize = typedArrayObtainStyledAttributes.getDimension(1, 0.0f);
        this.mUnitTextSize = typedArrayObtainStyledAttributes.getDimension(7, 0.0f);
        this.mUnitMarginTop = typedArrayObtainStyledAttributes.getDimension(5, 0.0f);
        this.mDataColor = typedArrayObtainStyledAttributes.getColorStateList(2);
        this.mUnitColor = typedArrayObtainStyledAttributes.getColorStateList(8);
        this.data = typedArrayObtainStyledAttributes.getString(0);
        this.unit = typedArrayObtainStyledAttributes.getString(6);
        typedArrayObtainStyledAttributes.recycle();
    }

    private void initView() {
        LayoutInflater.from(getContext()).inflate(com.boat.Xtend.two.R.layout.widget_sport_info, (ViewGroup) this, true);
