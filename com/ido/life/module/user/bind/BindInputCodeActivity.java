...
public class BindInputCodeActivity extends BaseCoreActivity implements BindAccountContract.View {
    ...
    public static void startActivity(Activity activity) {
        activity.startActivity(new Intent(activity, (Class<?>) BindInputCodeActivity.class));
    }
    ...
    protected void initViews() {
        ...
        this.mMeSubmit.setText(LanguageUtil.getLanguageText(R.string.logn_third_band_account_ios));
    }
    ...
    private void initListener() {
        ...
        this.mPhoneView.setOnTextChangedListener(new OnTextChangedListener() { // from class: com.ido.life.module.user.bind.-$$Lambda$BindInputCodeActivity$3SQyb-rAUvKH4VpbgSjz36wAVTs
        ...
        this.mPasswordView.setOnTextChangedListener(new OnTextChangedListener() { // from class: com.ido.life.module.user.bind.-$$Lambda$BindInputCodeActivity$fKifjRGETj-VB1eaJZ2RDXRsmSQ
            @Override // com.ido.life.module.user.view.OnTextChangedListener
            public final void changed(String str) {
                this.f$0.lambda$initListener$1$BindInputCodeActivity(str);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$initListener$1$BindInputCodeActivity(String str) {
        this.mPresenter.checkSubmitEnable(this.mPhoneView.getPhone());
    }
    ...
    public void goUnRegisterSetPassword() {
        startActivity(new Intent(this, (Class<?>) ThirdBandSetPasswordActivity.class));
    }
    ...
    public void doClickSubmitBindAccount(View view) {
        this.mPresenter.doBindAlreadyRegister(this.mOauthId, this.mPhoneView.getPhone(), this.mPasswordView.getPassword(), this.mAccessToken, this.mOpenId, this.mPlatName);
    }
