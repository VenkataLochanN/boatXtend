...
public class BottomSportView extends FrameLayout {
    private String data;
    ...
    public BottomSportView(Context context) {
        this(context, null);
    }

    public BottomSportView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public BottomSportView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void initView() {
        LayoutInflater.from(getContext()).inflate(com.boat.Xtend.two.R.layout.widget_item_sport_data, (ViewGroup) this, true);
