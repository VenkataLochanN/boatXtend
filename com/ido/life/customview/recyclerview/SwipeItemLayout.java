...
public class SwipeItemLayout extends ViewGroup {
    private static final Interpolator sInterpolator = new Interpolator() { // from class: com.ido.life.customview.recyclerview.SwipeItemLayout.1
    ...
    /* JADX INFO: renamed from: com.ido.life.customview.recyclerview.SwipeItemLayout$2, reason: invalid class name */
    static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$ido$life$customview$recyclerview$SwipeItemLayout$Mode = new int[Mode.values().length];

        static {
            try {
                $SwitchMap$com$ido$life$customview$recyclerview$SwipeItemLayout$Mode[Mode.FLING.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$ido$life$customview$recyclerview$SwipeItemLayout$Mode[Mode.RESET.ordinal()] = 2;
    ...
    void setTouchMode(Mode mode) {
        if (AnonymousClass2.$SwitchMap$com$ido$life$customview$recyclerview$SwipeItemLayout$Mode[this.mTouchMode.ordinal()] == 1) {
    ...
    boolean trackMotionScroll(int i) {
        ...
        int iMax = this.mScrollOffset + i;
        if ((i <= 0 || iMax <= 0) && (i >= 0 || iMax >= (-this.mMaxScrollOffset))) {
            z = false;
        } else {
            z = true;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.mSideView.measure(View.MeasureSpec.makeMeasureSpec(0, 0), View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - (marginLayoutParams2.topMargin + marginLayoutParams2.bottomMargin)) - paddingTop, BasicMeasure.EXACTLY));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i9 = this.mMaxScrollOffset;
        this.mScrollOffset = i8 < (-i9) / 2 ? -i9 : 0;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (!this.mSupportSwipe) {
            return super.onInterceptTouchEvent(motionEvent);
        }
        int actionMasked = motionEvent.getActionMasked();
        if (actionMasked == 0) {
            View viewFindTopChildUnder = findTopChildUnder(this, (int) motionEvent.getX(), (int) motionEvent.getY());
            return (viewFindTopChildUnder == null || viewFindTopChildUnder != this.mMainView || this.mScrollOffset == 0) ? false : true;
        }
        if (actionMasked != 1) {
            return actionMasked != 2 ? false : false;
        }
        View viewFindTopChildUnder2 = findTopChildUnder(this, (int) motionEvent.getX(), (int) motionEvent.getY());
        return viewFindTopChildUnder2 != null && viewFindTopChildUnder2 == this.mMainView && this.mTouchMode == Mode.TAP && this.mScrollOffset != 0;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            View viewFindTopChildUnder = findTopChildUnder(this, (int) motionEvent.getX(), (int) motionEvent.getY());
            if (viewFindTopChildUnder != null && viewFindTopChildUnder == this.mMainView && this.mScrollOffset != 0) {
                return true;
            }
        } else if (actionMasked == 1) {
            View viewFindTopChildUnder2 = findTopChildUnder(this, (int) motionEvent.getX(), (int) motionEvent.getY());
            if (viewFindTopChildUnder2 != null && viewFindTopChildUnder2 == this.mMainView && this.mTouchMode == Mode.TAP && this.mScrollOffset != 0) {
                close();
                return true;
            }
    ...
    public static class OnSwipeItemTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ...
            if (actionMasked == 0) {
                ...
                this.mLastMotionX = x;
                this.mLastMotionY = y;
                View viewFindTopChildUnder = SwipeItemLayout.findTopChildUnder(recyclerView, (int) x, (int) y);
            ...
            float f2 = x2;
            int i2 = (int) (f2 - this.mLastMotionX);
            float y2 = (int) (((int) motionEvent.getY(iFindPointerIndex)) + 0.5f);
            ...
            if (swipeItemLayout7.getTouchMode() == Mode.TAP) {
                if (iAbs > this.mTouchSlop && iAbs > iAbs2) {
                    ...
                    this.mIsProbeParent = true;
                    boolean zOnInterceptTouchEvent = recyclerView.onInterceptTouchEvent(motionEvent);
                    this.mIsProbeParent = false;
        ...
        public void onTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ...
            if (actionMasked == 2) {
                ...
                float y = (int) motionEvent.getY(iFindPointerIndex);
