...
public class CommRefreshHeader extends ClassicsAbstract<CommRefreshHeader> implements RefreshHeader {
    ...
    public CommRefreshHeader(Context context, AttributeSet attributeSet) {
