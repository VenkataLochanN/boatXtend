            ...
            if (view instanceof CoordinatorLayout) {
                ...
                for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                    ...
                    if (childAt instanceof AppBarLayout) {
                        ((AppBarLayout) childAt).addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() { // from class: com.ido.smartrefresh.layoutkernel.util.DesignUtil.1
