...
public enum RefreshState {
    ...
    public static RefreshState from(com.ido.smartrefresh.layoutkernel.constant.RefreshState refreshState) {
        for (RefreshState refreshState2 : values()) {
            if (refreshState2.ordinal() == refreshState.ordinal()) {
