...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    public static final String VERSION = "1.2.38";
    ...
    static {
        ...
        if ("true".equals(stringProperty)) {
            mask |= mask2;
        } else if (Bugly.SDK_IS_DEV.equals(stringProperty)) {
            mask &= ~mask2;
        }
    ...
    public static <T> T parseObject(InputStream inputStream, Charset charset, Type type, Feature... featureArr) throws IOException {
        ...
        while (true) {
            ...
            if (i2 != -1) {
                ...
                return (T) parseObject(bArrAllocateBytes, 0, i, charset2, type, featureArr);
            }
        }
    }
