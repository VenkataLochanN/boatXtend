...
public class AwtCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (obj instanceof Point) {
            ...
            Font font = (Font) obj;
            serializeWriter.writeFieldValue(writeClassName(serializeWriter, Font.class, '{'), AppMeasurementSdk.ConditionalUserProperty.NAME, font.getName());
    ...
    protected Font parseFont(DefaultJSONParser defaultJSONParser) {
        ...
        while (jSONLexer.token() != 13) {
            if (jSONLexer.token() == 4) {
                ...
                if (strStringVal2.equalsIgnoreCase(AppMeasurementSdk.ConditionalUserProperty.NAME)) {
                    if (jSONLexer.token() == 4) {
