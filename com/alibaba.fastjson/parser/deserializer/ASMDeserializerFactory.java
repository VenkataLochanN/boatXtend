...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig parserConfig, JavaBeanInfo javaBeanInfo) throws Exception {
        ...
        String str2 = name.replace(FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX) + "/" + str;
                    ...
                    if (cls.isEnum()) {
                        ...
                        if (Collection.class.isAssignableFrom(cls)) {
                            ...
                            if (collectionItemClass == String.class) {
                                ...
                                methodWriter.visitVarInsn(25, context.var("lexer"));
                                methodWriter.visitMethodInsn(182, JSONLexerBase, Token.KEY_TOKEN, "()I");
                                methodWriter.visitVarInsn(54, context.var(Token.KEY_TOKEN));
                                methodWriter.visitVarInsn(21, context.var(Token.KEY_TOKEN));
    ...
    /* JADX WARN: Removed duplicated region for block: B:134:0x0e80  */
    /*
    ...
    */
    private void _deserialze(com.alibaba.fastjson.asm.ClassWriter r30, com.alibaba.fastjson.parser.deserializer.ASMDeserializerFactory.Context r31) {
        /*
            Method dump skipped, instruction units count: 4229
    ...
    private void _deserialize_endCheck(Context context, MethodVisitor methodVisitor, Label label) {
        ...
        methodVisitor.visitMethodInsn(182, JSONLexerBase, Token.KEY_TOKEN, "()I");
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor methodVisitor, Label label, FieldInfo fieldInfo, Class<?> cls, Class<?> cls2, int i) {
        ...
        if (zIsPrimitive2) {
            ...
            str = "nextToken";
            str2 = "(I)V";
            methodVisitor.visitMethodInsn(182, JSONLexerBase, str, str2);
        } else {
            str = "nextToken";
            str2 = "(I)V";
            methodVisitor.visitInsn(87);
