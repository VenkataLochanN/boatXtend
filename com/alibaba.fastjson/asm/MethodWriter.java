...
public class MethodWriter implements MethodVisitor {
    ...
    public void visitIincInsn(int i, int i2) {
        this.code.putByte(Sport100Type.SPORT_TYPE_BILLIARDS).put11(i, i2);
    }
    ...
    final int getSize() {
        ...
        if (this.code.length > 0) {
            this.cw.newUTF8(DatabaseHelper.authorizationCode);
    ...
    final void put(ByteVector byteVector) {
        ...
        if (this.code.length > 0) {
            byteVector.putShort(this.cw.newUTF8(DatabaseHelper.authorizationCode)).putInt(this.code.length + 12 + 0);
