...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.TabLayout, i, DEF_STYLE_RES, R.styleable.TabLayout_tabTextAppearance);
    ...
    */
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (TabLayout.this.tabSelectedIndicator.getBounds().width() > 0) {
                ...
                Drawable drawableWrap = TabLayout.this.tabSelectedIndicator;
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i, float f2, int i2) {
            ...
            if (tabLayout != null) {
                tabLayout.setScrollPosition(i, f2, this.scrollState != 2 || this.previousScrollState == 1, (this.scrollState == 2 && this.previousScrollState == 0) ? false : true);
            }
        }
