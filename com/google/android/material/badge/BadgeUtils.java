        ...
        toolbar.post(new Runnable() { // from class: com.google.android.material.badge.BadgeUtils.1
            ...
            public void run() {
                ...
                if (actionMenuItemView != null) {
                    ...
                    badgeDrawable3.setVerticalOffset(badgeDrawable3.getVerticalOffset() + toolbar.getResources().getDimensionPixelOffset(R.dimen.mtrl_badge_toolbar_action_menu_item_vertical_offset));
