...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        ...
        this.filledPopupBackground.addState(new int[]{android.R.attr.state_above_anchor}, popUpMaterialShapeDrawable);
    ...
    private void initAnimators() {
        ...
        this.fadeOutAnim.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.9
