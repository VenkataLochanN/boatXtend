...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.AppBarLayout, i, DEF_STYLE_RES, new int[0]);
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable materialShapeDrawable, boolean z) {
        ...
        this.elevationOverlayAnimator = ValueAnimator.ofFloat(f2, dimension);
        ...
        private int interpolateOffset(T t, int i) {
            ...
            while (true) {
                ...
                if (iAbs < childAt.getTop() || iAbs > childAt.getBottom()) {
                    ...
                    if (topInset > 0) {
                        float f2 = topInset;
                        return Integer.signum(i) * (childAt.getTop() + Math.round(f2 * scrollInterpolator.getInterpolation((iAbs - childAt.getTop()) / f2)));
                    }
                }
            }
            return i;
