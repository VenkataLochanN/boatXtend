...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable chipDrawableCreateFromAttributes = ChipDrawable.createFromAttributes(context2, attributeSet, i, DEF_STYLE_RES);
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, CommonDialog.EXTRA_GRAVITY, 8388627) != 8388627) {
