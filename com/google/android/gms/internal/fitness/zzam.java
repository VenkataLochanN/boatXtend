...
public final class zzam extends zzn<zzcb> {
    ...
    static {
        zzan zzanVar = null;
        API = new Api<>("Fitness.RECORDING_API", new zzao(), CLIENT_KEY);
        zzew = new Api<>("Fitness.RECORDING_CLIENT", new zzaq(), CLIENT_KEY);
    }
    ...
    public final /* synthetic */ IInterface createServiceInterface(IBinder iBinder) {
        ...
        return iInterfaceQueryLocalInterface instanceof zzcb ? (zzcb) iInterfaceQueryLocalInterface : new zzcc(iBinder);
    }
