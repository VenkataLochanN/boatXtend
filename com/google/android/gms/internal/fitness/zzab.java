...
public final class zzab extends zzn<zzbx> {
    ...
    static {
        zzac zzacVar = null;
        API = new Api<>("Fitness.GOALS_API", new zzad(), CLIENT_KEY);
        zzew = new Api<>("Fitness.GOALS_CLIENT", new zzaf(), CLIENT_KEY);
    }
    ...
    public final /* synthetic */ IInterface createServiceInterface(IBinder iBinder) {
        ...
        return iInterfaceQueryLocalInterface instanceof zzbx ? (zzbx) iInterfaceQueryLocalInterface : new zzby(iBinder);
    }
