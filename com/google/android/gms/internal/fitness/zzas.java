...
public final class zzas extends zzn<zzcd> {
    ...
    static {
        zzat zzatVar = null;
        API = new Api<>("Fitness.SENSORS_API", new zzau(), CLIENT_KEY);
        zzew = new Api<>("Fitness.SENSORS_CLIENT", new zzaw(), CLIENT_KEY);
    }
    ...
    public final /* synthetic */ IInterface createServiceInterface(IBinder iBinder) {
        ...
        return iInterfaceQueryLocalInterface instanceof zzcd ? (zzcd) iInterfaceQueryLocalInterface : new zzce(iBinder);
    }
