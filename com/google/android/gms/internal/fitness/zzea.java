...
public final class zzea implements SensorsApi {
    ...
    public final PendingResult<Status> add(GoogleApiClient googleApiClient, SensorRequest sensorRequest, OnDataPointListener onDataPointListener) {
        return zza(googleApiClient, sensorRequest, com.google.android.gms.fitness.request.zzan.zzw().zza(onDataPointListener), null);
    }
    ...
    public final PendingResult<Status> remove(GoogleApiClient googleApiClient, OnDataPointListener onDataPointListener) {
        com.google.android.gms.fitness.request.zzal zzalVarZzb = com.google.android.gms.fitness.request.zzan.zzw().zzb(onDataPointListener);
        return zzalVarZzb == null ? PendingResults.immediatePendingResult(Status.RESULT_SUCCESS, googleApiClient) : zza(googleApiClient, zzalVarZzb, null);
    }
}