...
public final class zzdj implements HistoryApi {
    ...
    public final PendingResult<Status> updateData(GoogleApiClient googleApiClient, DataUpdateRequest dataUpdateRequest) {
        ...
        Preconditions.checkNotZero(dataUpdateRequest.zzu(), "Must set a non-zero value for startTimeMillis/startTime");
        Preconditions.checkNotZero(dataUpdateRequest.zzv(), "Must set a non-zero value for endTimeMillis/endTime");
