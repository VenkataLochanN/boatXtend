    ...
    final String zza(byte[] bArr, int i, int i2) throws zzfm {
        ...
        while (i < i3) {
            ...
            if (zzie.zzd(b3)) {
                ...
                if (i6 < i3 - 1) {
                    int i8 = i6 + 1;
                    zzie.zzb(b3, bArr[i6], bArr[i8], cArr, i5);
                    i = i8 + 1;
                    i5++;
                } else {
                    throw zzfm.zzh();
                ...
                byte b5 = bArr[i6];
                int i10 = i9 + 1;
                zzie.zzb(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                i = i10 + 1;
                i5 = i5 + 1 + 1;
            }
        }
        ...
        while (i7 < length) {
            ...
            if (cCharAt2 >= 128 || i8 >= i6) {
                if (cCharAt2 < 2048 && i8 <= i6 - 2) {
                    ...
                    int i14 = i8 + 1;
                    bArr[i8] = (byte) ((cCharAt2 >>> '\f') | GlMapUtil.DEVICE_DISPLAY_DPI_XHIGH);
                    int i15 = i14 + 1;
