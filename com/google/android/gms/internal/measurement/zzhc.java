...
interface zzhc {
    ...
    <T> T zza(zzhf<T> zzhfVar, zzer zzerVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzhf<T> zzhfVar, zzer zzerVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzgh<K, V> zzghVar, zzer zzerVar) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzhf<T> zzhfVar, zzer zzerVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzhf<T> zzhfVar, zzer zzerVar) throws IOException;
    ...
    void zzk(List<zzdw> list) throws IOException;
