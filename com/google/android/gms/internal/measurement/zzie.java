...
final class zzie {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void zzb(byte b2, byte b3, char[] cArr, int i) throws zzfm {
        if (b2 < -62 || zzg(b3)) {
            throw zzfm.zzh();
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void zzb(byte b2, byte b3, byte b4, char[] cArr, int i) throws zzfm {
        if (zzg(b3) || ((b2 == -32 && b3 < -96) || ((b2 == -19 && b3 >= -96) || zzg(b4)))) {
            throw zzfm.zzh();
        }
        cArr[i] = (char) (((b2 & DfuConstants.BANK_INFO_NOT_SUPPORTED) << 12) | ((b3 & 63) << 6) | (b4 & 63));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void zzb(byte b2, byte b3, byte b4, byte b5, char[] cArr, int i) throws zzfm {
