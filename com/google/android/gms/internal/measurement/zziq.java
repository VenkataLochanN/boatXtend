...
interface zziq {
    ...
    void zza(int i, double d2) throws IOException;

    void zza(int i, float f2) throws IOException;

    void zza(int i, int i2) throws IOException;

    void zza(int i, long j) throws IOException;

    void zza(int i, zzdw zzdwVar) throws IOException;

    <K, V> void zza(int i, zzgh<K, V> zzghVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhf zzhfVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhf zzhfVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhf zzhfVar) throws IOException;

    void zzb(int i, List<zzdw> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhf zzhfVar) throws IOException;
