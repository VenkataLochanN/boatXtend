...
public final class zzjh implements zzje {
    ...
    static {
        ...
        zza = zzctVar.zza("measurement.ad_id_cache_time", DfuConfig.CONNECTION_PARAMETERS_UPDATE_TIMEOUT);
        zzb = zzctVar.zza("measurement.config.cache_time", DateUtil.DAY);
        zzc = zzctVar.zza("measurement.log_tag", "FA");
        zzd = zzctVar.zza("measurement.config.url_authority", "app-measurement.com");
        zze = zzctVar.zza("measurement.config.url_scheme", "https");
        ...
        zzk = zzctVar.zza("measurement.alarm_manager.minimum_interval", DateUtil.MINUTE);
        zzl = zzctVar.zza("measurement.upload.minimum_delay", 500L);
        zzm = zzctVar.zza("measurement.monitoring.sample_period_millis", DateUtil.DAY);
        zzn = zzctVar.zza("measurement.upload.realtime_upload_interval", DfuConfig.CONNECTION_PARAMETERS_UPDATE_TIMEOUT);
        zzo = zzctVar.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000L);
        zzp = zzctVar.zza("measurement.config.cache_time.service", DateUtil.HOUR);
        zzq = zzctVar.zza("measurement.service_client.idle_disconnect_millis", BootloaderScanner.TIMEOUT);
        zzr = zzctVar.zza("measurement.log_tag.service", "FA-SVC");
        zzs = zzctVar.zza("measurement.upload.stale_data_deletion_interval", DateUtil.DAY);
        ...
        zzv = zzctVar.zza("measurement.upload.interval", DateUtil.HOUR);
        zzw = zzctVar.zza("measurement.upload.max_bundle_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzaf = zzctVar.zza("measurement.upload.max_batch_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzaj = zzctVar.zza("measurement.upload.window_interval", DateUtil.HOUR);
    }
}