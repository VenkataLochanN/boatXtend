...
public final class zzap {
    ...
    private static <V> zzeu<V> zza(String str, V v, V v2, zzes<V> zzesVar) {
    ...
    static {
        Long lValueOf = Long.valueOf(DfuConfig.CONNECTION_PARAMETERS_UPDATE_TIMEOUT);
        zza = zza("measurement.ad_id_cache_time", lValueOf, lValueOf, zzas.zza);
        Long lValueOf2 = Long.valueOf(DateUtil.DAY);
        zzb = zza("measurement.monitoring.sample_period_millis", lValueOf2, lValueOf2, zzar.zza);
        Long lValueOf3 = Long.valueOf(DateUtil.HOUR);
        zzc = zza("measurement.config.cache_time", lValueOf2, lValueOf3, zzbf.zza);
        zzd = zza("measurement.config.url_scheme", "https", "https", zzbs.zza);
        zze = zza("measurement.config.url_authority", "app-measurement.com", "app-measurement.com", zzcb.zza);
        zzf = zza("measurement.upload.max_bundles", 100, 100, zzco.zza);
        zzg = zza("measurement.upload.max_batch_size", 65536, 65536, zzcx.zza);
        zzh = zza("measurement.upload.max_bundle_size", 65536, 65536, zzdk.zza);
        zzi = zza("measurement.upload.max_events_per_bundle", 1000, 1000, zzdt.zza);
        Integer numValueOf = Integer.valueOf(BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH);
        zzj = zza("measurement.upload.max_events_per_day", numValueOf, numValueOf, zzeg.zza);
        ...
        zzl = zza("measurement.upload.max_public_events_per_day", numValueOf2, numValueOf2, zzay.zza);
        zzm = zza("measurement.upload.max_conversions_per_day", 500, 500, zzax.zza);
        zzn = zza("measurement.upload.max_realtime_events_per_day", 10, 10, zzba.zza);
        Integer numValueOf3 = Integer.valueOf(BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH);
        zzo = zza("measurement.store.max_stored_events_per_app", numValueOf3, numValueOf3, zzaz.zza);
        zzp = zza("measurement.upload.url", "https://app-measurement.com/a", "https://app-measurement.com/a", zzbc.zza);
        zzq = zza("measurement.upload.backoff_period", 43200000L, 43200000L, zzbb.zza);
        zzr = zza("measurement.upload.window_interval", lValueOf3, lValueOf3, zzbe.zza);
        zzs = zza("measurement.upload.interval", lValueOf3, lValueOf3, zzbd.zza);
        zzt = zza("measurement.upload.realtime_upload_interval", lValueOf, lValueOf, zzbg.zza);
        zzu = zza("measurement.upload.debug_upload_interval", 1000L, 1000L, zzbi.zza);
        zzv = zza("measurement.upload.minimum_delay", 500L, 500L, zzbh.zza);
        Long lValueOf4 = Long.valueOf(DateUtil.MINUTE);
        zzw = zza("measurement.alarm_manager.minimum_interval", lValueOf4, lValueOf4, zzbk.zza);
        zzx = zza("measurement.upload.stale_data_deletion_interval", lValueOf2, lValueOf2, zzbj.zza);
        zzy = zza("measurement.upload.refresh_blacklisted_config_interval", 604800000L, 604800000L, zzbm.zza);
        zzz = zza("measurement.upload.initial_upload_delay_time", 15000L, 15000L, zzbl.zza);
        zzaa = zza("measurement.upload.retry_time", 1800000L, 1800000L, zzbo.zza);
        zzab = zza("measurement.upload.retry_count", 6, 6, zzbn.zza);
        zzac = zza("measurement.upload.max_queue_time", 2419200000L, 2419200000L, zzbq.zza);
        ...
        Long lValueOf5 = Long.valueOf(BootloaderScanner.TIMEOUT);
        zzaf = zza("measurement.service_client.idle_disconnect_millis", lValueOf5, lValueOf5, zzbu.zza);
        zzag = zza("measurement.test.boolean_flag", false, false, zzbt.zza);
        zzah = zza("measurement.test.string_flag", "---", "---", zzbw.zza);
        zzai = zza("measurement.test.long_flag", -1L, -1L, zzbv.zza);
        zzaj = zza("measurement.test.int_flag", -2, -2, zzby.zza);
