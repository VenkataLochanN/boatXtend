...
final class zzad extends SQLiteOpenHelper {
    ...
    zzad(zzac zzacVar, Context context, String str) {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        if (!this.zza.zzk.zza(DateUtil.HOUR)) {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        ...
        zzag.zza(this.zza.zzr(), sQLiteDatabase, "user_attributes", "CREATE TABLE IF NOT EXISTS user_attributes ( app_id TEXT NOT NULL, name TEXT NOT NULL, set_timestamp INTEGER NOT NULL, value BLOB NOT NULL, PRIMARY KEY (app_id, name)) ;", "app_id,name,set_timestamp,value", zzac.zzc);
        ...
        zzag.zza(this.zza.zzr(), sQLiteDatabase, "queue", "CREATE TABLE IF NOT EXISTS queue ( app_id TEXT NOT NULL, bundle_end_timestamp INTEGER NOT NULL, data BLOB NOT NULL);", "app_id,bundle_end_timestamp,data", zzac.zzf);
        ...
        zzag.zza(this.zza.zzr(), sQLiteDatabase, "app2", "CREATE TABLE IF NOT EXISTS app2 ( app_id TEXT NOT NULL, first_open_count INTEGER NOT NULL, PRIMARY KEY (app_id));", "app_id,first_open_count", zzac.zzi);
