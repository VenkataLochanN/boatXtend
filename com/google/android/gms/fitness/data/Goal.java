...
public class Goal extends AbstractSafeParcelable {
    ...
    public static class DurationObjective extends AbstractSafeParcelable {
        ...
        public String toString() {
            return Objects.toStringHelper(this).add(d.C, Long.valueOf(this.zzdr)).toString();
        }
    ...
    public static class Recurrence extends AbstractSafeParcelable {
        ...
        public String toString() {
            String str;
            Objects.ToStringHelper toStringHelperAdd = Objects.toStringHelper(this).add("count", Integer.valueOf(this.count));
            int i = this.zzdu;
            if (i == 1) {
                str = "day";
            } else if (i == 2) {
