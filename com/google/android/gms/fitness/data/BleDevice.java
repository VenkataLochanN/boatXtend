...
public class BleDevice extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(AppMeasurementSdk.ConditionalUserProperty.NAME, this.name).add("address", this.zzaf).add("dataTypes", this.zzah).add("supportedProfiles", this.zzag).toString();
    }
