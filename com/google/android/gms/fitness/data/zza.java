...
public final class zza {
    ...
    static {
        ...
        zzac = map;
        map.put(DataType.zzbm, Collections.singletonList(DataType.zzbn));
        zzac.put(DataType.zzbq, Collections.singletonList(DataType.zzbr));
        ...
        zzac.put(DataType.zzbl, Collections.singletonList(DataType.zzbs));
        zzac.put(DataType.zzbk, Collections.singletonList(DataType.zzbt));
        ...
        zzac.put(DataType.zzbf, Collections.singletonList(DataType.zzbp));
