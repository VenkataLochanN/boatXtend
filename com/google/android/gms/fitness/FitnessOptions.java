...
public class FitnessOptions implements GoogleSignInOptionsExtension, Api.ApiOptions.HasGoogleSignInAccountOptions {
    ...
    public static final class Builder {
        ...
        public final Builder addDataType(DataType dataType, int i) {
            ...
            List<DataType> arrayList = this.zzn.get(i);
            if (arrayList == null) {
                arrayList = new ArrayList<>();
                this.zzn.put(i, arrayList);
            }
    ...
    private FitnessOptions(SparseArray<List<DataType>> sparseArray, GoogleSignInAccount googleSignInAccount) {
        ...
        for (int i = 0; i < sparseArray.size(); i++) {
            ...
            for (DataType dataType : sparseArray.valueAt(i)) {
                if (iKeyAt == 0 && dataType.zzk() != null) {
                    scope = new Scope(dataType.zzk());
                } else if (iKeyAt == 1 && dataType.zzl() != null) {
                    scope = new Scope(dataType.zzl());
                }
                arrayList.add(scope);
            }
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (Objects.equal(this.zzk, fitnessOptions.zzk) && Objects.equal(this.zzm, fitnessOptions.zzm)) {
                return true;
            }
        }
        return false;
