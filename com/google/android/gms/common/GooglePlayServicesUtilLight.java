...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzal.get()) {
            ...
            if (iZzd != i2) {
                StringBuilder sb = new StringBuilder(GlMapUtil.DEVICE_DISPLAY_DPI_HIGH);
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        return PlatformVersion.isAtLeastJellyBeanMR2() && (applicationRestrictions = ((UserManager) context.getSystemService(BaseUrl.URL_NAME_USER)).getApplicationRestrictions(context.getPackageName())) != null && "true".equals(applicationRestrictions.getString("restricted_profile"));
    }
}