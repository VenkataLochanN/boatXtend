...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            resultPointCorrectTopRightRectangular = correctTopRightRectangular(resultPoint12, resultPoint11, resultPoint13, resultPoint, i, i2);
            if (resultPointCorrectTopRightRectangular == null) {
                resultPointCorrectTopRightRectangular = resultPoint;
            }
            int transitions3 = transitionsBetween(resultPoint2, resultPointCorrectTopRightRectangular).getTransitions();
            int transitions4 = transitionsBetween(resultPoint11, resultPointCorrectTopRightRectangular).getTransitions();
            if ((transitions3 & 1) == 1) {
                transitions3++;
            }
            int i3 = transitions3;
            ...
            bitMatrixSampleGrid = sampleGrid(this.image, resultPoint2, resultPoint12, resultPoint11, resultPointCorrectTopRightRectangular, i3, transitions4);
        } else {
            resultPointCorrectTopRightRectangular = correctTopRight(resultPoint12, resultPoint11, resultPoint13, resultPoint, Math.min(i2, i));
            if (resultPointCorrectTopRightRectangular == null) {
                resultPointCorrectTopRightRectangular = resultPoint;
            }
            int iMax = Math.max(transitionsBetween(resultPoint13, resultPointCorrectTopRightRectangular).getTransitions(), transitionsBetween(resultPoint11, resultPointCorrectTopRightRectangular).getTransitions()) + 1;
            if ((iMax & 1) == 1) {
                iMax++;
            }
            int i4 = iMax;
            bitMatrixSampleGrid = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, resultPointCorrectTopRightRectangular, i4, i4);
            resultPoint2 = resultPoint13;
        }
        return new DetectorResult(bitMatrixSampleGrid, new ResultPoint[]{resultPoint2, resultPoint12, resultPoint11, resultPointCorrectTopRightRectangular});
    }
