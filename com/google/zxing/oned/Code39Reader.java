...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, 289, 97, b.q1, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, DfuException.ERROR_ENTER_OTA_MODE_FAILED, 88, 13, DfuException.ERROR_SEND_COMMAND_REACH_MAX_RETRY_TIMES, 76, 28, 259, 67, b.e1, 19, DfuException.ERROR_USER_NOT_ACTIVE_IMAGE_ERROR, 82, 7, 262, 70, 22, 385, 193, 448, 145, 400, 208, 133, 388, 196, 168, 162, Sport100Type.SPORT_TYPE_SHUTTLECOCK, 42};
    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        while (true) {
            ...
            if (cPatternToChar == '*') {
                ...
                float f2 = i;
                return new Result(string, null, new ResultPoint[]{new ResultPoint((r2[1] + r2[0]) / 2.0f, f2), new ResultPoint(nextSet + (i4 / 2.0f), f2)}, BarcodeFormat.CODE_39);
            }
            nextSet = nextSet2;
        }
    }
