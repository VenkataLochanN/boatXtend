...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, ChecksumException, FormatException {
        ...
        for (int i10 = 1; i10 <= barcodeColumnCount; i10++) {
            ...
            if (detectionResultMerge.getDetectionResultColumn(i11) == null) {
                ...
                detectionResultMerge.setDetectionResultColumn(i11, detectionResultRowIndicatorColumn2);
                int i12 = -1;
                int iMax = i9;
                int i13 = -1;
                int iMin = i8;
                ...
                while (minY <= boundingBox.getMaxY()) {
                    int startColumn = getStartColumn(detectionResultMerge, i11, minY, z);
                    ...
                    int i14 = iMax;
                    i5 = i12;
                    Codeword codewordDetectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z, i6, minY, iMin, i14);
                    if (codewordDetectCodeword != null) {
                        ...
                        iMax = Math.max(i14, codewordDetectCodeword.getWidth());
                        i13 = i6;
                        minY++;
                        i12 = i5;
                    } else {
