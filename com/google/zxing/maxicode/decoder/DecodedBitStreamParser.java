...
final class DecodedBitStreamParser {
    ...
    private static int getCountry(byte[] bArr) {
        return getInt(bArr, new byte[]{53, 54, 43, 44, MultipartStream.DASH, 46, 47, Mmi.AU_MMI_VOL_UP, 37, 38});
    }

    private static int getServiceClass(byte[] bArr) {
        return getInt(bArr, new byte[]{55, 56, 57, 58, 59, 60, Mmi.AU_MMI_VOL_DOWN, 50, Parameters.RWS_CHANNEL_2, 52});
    }
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{Parameters.RWS_CHANNEL_1, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, Mmi.AU_MMI_UPDATE_INDICATOR, 21, 22, 23, 24, 13, 14, DfuConstants.BANK_INFO_NOT_SUPPORTED, 16, 17, Parameters.RWS_CHANNEL_0, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, 31, 32})), SETS[0].charAt(getInt(bArr, new byte[]{Parameters.RWS_CHANNEL_1, 34, 35, 36, 25, 26})), SETS[0].charAt(getInt(bArr, new byte[]{27, 28, 29, 30, 19, Mmi.AU_MMI_UPDATE_INDICATOR})), SETS[0].charAt(getInt(bArr, new byte[]{21, 22, 23, 24, 13, 14})), SETS[0].charAt(getInt(bArr, new byte[]{DfuConstants.BANK_INFO_NOT_SUPPORTED, 16, 17, Parameters.RWS_CHANNEL_0, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
        ...
        while (i3 < i + i2) {
            ...
            switch (cCharAt) {
                ...
                case 65531:
                    ...
                    int i8 = bArr[i7] << 24;
                    int i9 = i7 + 1;
                    int i10 = i8 + (bArr[i9] << Parameters.RWS_CHANNEL_0);
                    int i11 = i9 + 1;
