...
public final class Encoder {
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            if (z2) {
                z = z2;
                if (bitArrayStuffBits2.getSize() > (i4 << 6)) {
                    throw new IllegalArgumentException("Data to large for user specified layer");
                }
            }
        } else {
            ...
            int i11 = 0;
            while (i11 <= 32) {
                boolean z3 = i11 <= 3 ? i8 : i7;
                int i12 = z3 != 0 ? i11 + 1 : i11;
                ...
                if (size2 <= i13) {
                    ...
                    int i15 = i13 - (i13 % i4);
                    if ((z3 == 0 || bitArrayStuffBits.getSize() <= (i4 << 6)) && bitArrayStuffBits.getSize() + size <= i15) {
