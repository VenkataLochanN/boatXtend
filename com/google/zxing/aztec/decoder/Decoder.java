...
public final class Decoder {
    ...
    private static final String[] UPPER_TABLE = {"CTRL_PS", " ", "A", FileSizeUtil.UNIT_BIT, "C", "D", "E", "F", FileSizeUtil.UNIT_GB, "H", "I", "J", FileSizeUtil.UNIT_KB, "L", FileSizeUtil.UNIT_MB, "N", "O", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z", "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", "c", "d", "e", "f", "g", "h", "i", z.j, hl.k, "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", IOUtils.LINE_SEPARATOR_UNIX, "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", "|", "~", "\u007f", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", IOUtils.LINE_SEPARATOR_WINDOWS, ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", "+", AppInfo.DELIM, "-", ".", "/", ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", AlexaCustomSkillConstant.EVENT_UN_RECOGNIZE, "1", "2", Constants.DIALDEFNED_VERSION_CONNECT, AlexaCustomSkillConstant.EVENT_START_SPORT, "5", "6", "7", AlexaCustomSkillConstant.EVENT_BRIGHTNESS, AlexaCustomSkillConstant.EVENT_HR, AppInfo.DELIM, ".", "CTRL_UL", "CTRL_US"};
