...
public final class CalendarParsedResult extends ParsedResult {
    ...
    private static final long[] RFC2445_DURATION_FIELD_UNITS = {604800000, DateUtil.DAY, DateUtil.HOUR, DateUtil.MINUTE, 1000};
    ...
    private static long parseDate(String str) throws ParseException {
        ...
        if (str.length() == 16 && str.charAt(15) == 'Z') {
            ...
            long j = dateTimeString + ((long) gregorianCalendar.get(15));
