...
public final class FirebaseAnalytics {
            ...
            synchronized (FirebaseAnalytics.class) {
                if (zza == null) {
                    if (zzx.zzb(context)) {
                        ...
                        zza = new FirebaseAnalytics(zzgf.zza(context, (zzv) null));
                    }
                }
            }
        }
    ...
    public final void logEvent(String str, Bundle bundle) {
        if (this.zzd) {
            ...
            this.zzb.zzh().zza(FileDialDefinedUtil.APP_FILE, str, bundle, true);
        }
    }
    ...
    public final void setUserProperty(String str, String str2) {
        if (this.zzd) {
            ...
            this.zzb.zzh().zza(FileDialDefinedUtil.APP_FILE, str, (Object) str2, false);
        }
    }
    ...
    public final void setUserId(String str) {
        if (this.zzd) {
            ...
            this.zzb.zzh().zza(FileDialDefinedUtil.APP_FILE, "_id", (Object) str, true);
        }
    }
    ...
    public final String zzb() {
        ...
        synchronized (this.zzg) {
            if (this.zzd) {
                jElapsedRealtime = DefaultClock.getInstance().elapsedRealtime();
            } else {
                jElapsedRealtime = this.zzb.zzm().elapsedRealtime();
            }
            if (Math.abs(jElapsedRealtime - this.zzf) >= 1000) {
                return null;
            }
            return this.zze;
        }
    ...
    public static zzif getScionFrontendApiImplementation(Context context, Bundle bundle) {
        zzx zzxVarZza;
        if (zzx.zzb(context) && (zzxVarZza = zzx.zza(context, (String) null, (String) null, (String) null, bundle)) != null) {
            return new zzb(zzxVarZza);
        }
        return null;
    }
}