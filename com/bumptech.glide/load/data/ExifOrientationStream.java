...
public class ExifOrientationStream extends FilterInputStream {
    ...
    private static final byte[] EXIF_SEGMENT = {-1, -31, 0, 28, 69, 120, 105, 102, 0, 0, 77, 77, 0, 0, 0, 0, 0, 8, 0, 1, 1, Parameters.RWS_CHANNEL_0, 0, 2, 0, 0, 0, 1, 0};
    ...
    public int read() throws IOException {
        ...
        if (i3 < 2 || i3 > (i2 = ORIENTATION_POSITION)) {
            ...
            i = EXIF_SEGMENT[i3 - 2] & UByte.MAX_VALUE;
        }
        if (i != -1) {
            this.position++;
        }
