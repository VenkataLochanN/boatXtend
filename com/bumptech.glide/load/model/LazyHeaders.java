    ...
    public static final class Builder {
        ...
        static {
            ...
            if (!TextUtils.isEmpty(DEFAULT_USER_AGENT)) {
                map.put(USER_AGENT_HEADER, Collections.singletonList(new StringHeaderFactory(DEFAULT_USER_AGENT)));
            }
            map.put(ENCODING_HEADER, Collections.singletonList(new StringHeaderFactory(DEFAULT_ENCODING)));
