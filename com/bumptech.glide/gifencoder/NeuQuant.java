...
class NeuQuant {
    ...
    public void learn() {
        ...
        int i15 = 0;
        while (i15 < i6) {
            int i16 = (bArr[i13 + 0] & UByte.MAX_VALUE) << 4;
            int i17 = (bArr[i13 + 1] & UByte.MAX_VALUE) << 4;
            int i18 = (bArr[i13 + 2] & UByte.MAX_VALUE) << 4;
            int iContest = contest(i16, i17, i18);
            altersingle(i14, iContest, i16, i17, i18);
            if (i12 != 0) {
                alterneigh(i12, iContest, i16, i17, i18);
            }
            i13 += i;
            if (i13 >= i5) {
                i13 -= this.lengthcount;
            }
            i15++;
            if (i10 == 0) {
                i10 = 1;
            ...
            if (i15 % i10 == 0) {
                ...
                for (int i20 = 0; i20 < i19; i20++) {
                    int i21 = i19 * i19;
                    this.radpower[i20] = (((i21 - (i20 * i20)) * 256) / i21) * i14;
                }
                i12 = i19;
            }
        }
