...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> mo17clone() {
        try {
            ...
            genericRequestBuilder.loadProvider = this.loadProvider != null ? this.loadProvider.m18clone() : null;
    ...
    public <Y extends Target<TranscodeType>> Y into(Y y) {
        ...
        Request requestBuildRequest = buildRequest(y);
        y.setRequest(requestBuildRequest);
        this.lifecycle.addListener(y);
        this.requestTracker.runRequest(requestBuildRequest);
        return y;
    }
    ...
    /* JADX INFO: renamed from: com.bumptech.glide.GenericRequestBuilder$2, reason: invalid class name */
    ...
    private Request buildRequestRecursive(Target<TranscodeType> target, ThumbnailRequestCoordinator thumbnailRequestCoordinator) {
        ...
        if (genericRequestBuilder != null) {
            ...
            Request requestObtainRequest = obtainRequest(target, this.sizeMultiplier.floatValue(), this.priority, thumbnailRequestCoordinator2);
            this.isThumbnailBuilt = true;
            Request requestBuildRequestRecursive = this.thumbnailRequestBuilder.buildRequestRecursive(target, thumbnailRequestCoordinator2);
