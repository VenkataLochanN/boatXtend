...
public class RequestManager implements LifecycleListener {
    ...
    public DrawableTypeRequest<Uri> fromMediaStore() {
        ...
        ModelLoader modelLoaderBuildFileDescriptorModelLoader = Glide.buildFileDescriptorModelLoader(Uri.class, this.context);
        OptionsApplier optionsApplier = this.optionsApplier;
        return (DrawableTypeRequest) optionsApplier.apply(new DrawableTypeRequest(Uri.class, mediaStoreStreamLoader, modelLoaderBuildFileDescriptorModelLoader, this.context, this.glide, this.requestTracker, this.lifecycle, optionsApplier));
    }
    ...
    private <T> DrawableTypeRequest<T> loadGeneric(Class<T> cls) {
        ...
        OptionsApplier optionsApplier = this.optionsApplier;
        return (DrawableTypeRequest) optionsApplier.apply(new DrawableTypeRequest(cls, modelLoaderBuildStreamModelLoader, modelLoaderBuildFileDescriptorModelLoader, this.context, this.glide, this.requestTracker, this.lifecycle, optionsApplier));
    }
