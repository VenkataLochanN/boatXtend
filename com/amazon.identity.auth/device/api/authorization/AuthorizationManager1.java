...
import com.amazon.identity.auth.device.authorization.InternalAuthManager1;
...
public final class AuthorizationManager1 {
    ...
    public static void setSandboxMode(Context context, boolean z) {
        ...
        if (zIsSandboxMode != z) {
            ...
            signOut(context, new Listener<Void, AuthError>() { // from class: com.amazon.identity.auth.device.api.authorization.AuthorizationManager1.1
    ...
    public static void authorize(final AuthorizeRequest authorizeRequest) {
        ...
        InternalAuthManager1.getInstance(context).authorize(authorizeRequest, context, strArr, bundle, new AuthorizationListener() { // from class: com.amazon.identity.auth.device.api.authorization.AuthorizationManager1.2
    ...
    public static void getToken(Context context, Scope[] scopeArr, final Listener<AuthorizeResult, AuthError> listener) {
        ...
        InternalAuthManager.getInstance(context).getToken(context, strArr, new APIListener() { // from class: com.amazon.identity.auth.device.api.authorization.AuthorizationManager1.3
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.amazon.identity.auth.device.api.Listener
    ...
    public static void signOut(Context context, final Listener<Void, AuthError> listener) {
        ...
        InternalAuthManager.getInstance(context).clearAuthorizationState(context, new APIListener() { // from class: com.amazon.identity.auth.device.api.authorization.AuthorizationManager1.4
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.amazon.identity.auth.device.api.Listener
            public void onSuccess(Bundle bundle) {
