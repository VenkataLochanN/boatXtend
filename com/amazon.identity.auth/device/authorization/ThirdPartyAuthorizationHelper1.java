...
public class ThirdPartyAuthorizationHelper1 extends AuthorizationHelper {
    ...
    public ThirdPartyAuthorizationHelper1() {
        this(new ThirdPartyServiceHelper());
    }

    public ThirdPartyAuthorizationHelper1(ThirdPartyServiceHelper thirdPartyServiceHelper) {
    ...
    public void authorize(Context context, String str, String str2, String str3, String[] strArr, boolean z, TokenVendor tokenVendor, AuthorizationListener authorizationListener) throws AuthError {
        authorize((AuthorizeRequest) null, context, str, str2, str3, strArr, z, tokenVendor, authorizationListener, Bundle.EMPTY);
    }
    ...
    public void authorize(Context context, String str, String str2, String str3, String[] strArr, boolean z, TokenVendor tokenVendor, AuthorizationListener authorizationListener, Bundle bundle) throws AuthError {
        authorize((AuthorizeRequest) null, context, str, str2, str3, strArr, z, tokenVendor, authorizationListener, bundle);
    }
    ...
    public void authorize(final AuthorizeRequest authorizeRequest, final Context context, String str, final String str2, String str3, String[] strArr, final boolean z, TokenVendor tokenVendor, final AuthorizationListener authorizationListener, Bundle bundle) throws AuthError {
        ...
        try {
            ...
            if (!z2 && !StoredPreferences.isTokenObtainedFromSSO(context) && cachedScopes != null) {
                cachedScopes.size();
            }
            ...
            if (!bundle4.containsKey(AuthError.AUTH_ERROR_EXECEPTION) && !bundle4.containsKey(AuthzConstants.BUNDLE_KEY.AUTHORIZE.val) && !bundle4.containsKey(AuthzConstants.BUNDLE_KEY.CAUSE_ID.val)) {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.amazon.identity.auth.device.authorization.ThirdPartyAuthorizationHelper1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        try {
                            if (z || z2) {
                                ThirdPartyAuthorizationHelper1.this.authorizeWithBrowser(authorizeRequest, context, context.getPackageName(), str2, commonScopesForAuthorization, authorizationListener, bundle3, appInfo);
    ...
    private void handleCodeForTokenExchange(Context context, String str, String str2, Bundle bundle, Bundle bundle2, final AuthorizationListener authorizationListener) {
        doCodeForTokenExchange(context, str, str2, bundle, false, (String) null, new TokenVendor(), new ThirdPartyAppIdentifier(), bundle2, new AuthorizationListener() { // from class: com.amazon.identity.auth.device.authorization.ThirdPartyAuthorizationHelper1.2
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.amazon.identity.auth.device.api.Listener
            public void onSuccess(Bundle bundle3) {
                MAPLog.i(ThirdPartyAuthorizationHelper1.LOG_TAG, "Code for Token Exchange success");
            ...
            public void onError(AuthError authError) {
                MAPLog.e(ThirdPartyAuthorizationHelper1.LOG_TAG, "Code for Token Exchange Error. " + authError.getMessage());
                AuthorizationListener authorizationListener2 = authorizationListener;
                if (authorizationListener2 != null) {
            ...
            public void onCancel(Bundle bundle3) {
                MAPLog.w(ThirdPartyAuthorizationHelper1.LOG_TAG, "Code for Token Exchange Cancel");
                AuthorizationListener authorizationListener2 = authorizationListener;
                if (authorizationListener2 != null) {
    ...
    private Bundle startAuthorizationWithService(Context context, final String[] strArr, final Bundle bundle) throws AuthError {
        Bundle bundleExecute = new LWAServiceWrapper<Bundle>() { // from class: com.amazon.identity.auth.device.authorization.ThirdPartyAuthorizationHelper1.3
            ...
            public Bundle doWork(Context context2, AmazonAuthorizationServiceInterface amazonAuthorizationServiceInterface) throws AuthError, RemoteException {
                return ThirdPartyAuthorizationHelper1.authorizeWithService(context2, strArr, amazonAuthorizationServiceInterface, bundle);
            }
