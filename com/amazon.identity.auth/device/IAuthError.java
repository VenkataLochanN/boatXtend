...
public interface IAuthError extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAuthError {
        ...
        public static IAuthError asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IAuthError)) {
                return (IAuthError) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements IAuthError {
