...
public class AMapEngineUtils {
    ...
    public static final String MAP_MAP_ASSETS_ICON_5_NAME = "icons_5_16_1561028345.data";
    public static final String MAP_MAP_ASSETS_ICON_5_NAME_FOR_CUSTOM = "icons-for_custom_5_14.data";
    public static final String MAP_MAP_ASSETS_NAME = "map_assets";
    public static final String MAP_MAP_ASSETS_STYLE_DATA = "style_1_16_1562032355.data";
    public static final String MAP_MAP_ASSETS_STYLE_DATA_0_FOR_TEXTURE = "style-for_custom_0_16_1561381751.data";
