...
public class AdglMapAnimGroup extends AbstractAdglAnimation {
    ...
    public void commitAnimation(Object obj) {
        ...
        if (this.needMove && this.moveParam != null) {
            ...
            int i = iPointObtain.x;
            int i2 = iPointObtain.y;
        ...
        if (this.needZoom) {
            ...
            if (this.hasMidZoom) {
                if (this.offsetTime <= this.startZoomDuration) {
                    ...
                    this.zoomEndParam.setNormalizedTime(((this.offsetTime - ((long) this.startZoomDuration)) - ((long) this.midZoomDuration)) / this.endZoomDuration);
