...
public class AdglMapAnimFling extends AbstractAdglAnimation {
    ...
    public void commitAnimationold(Object obj) {
        ...
        float fSqrt = ((float) Math.sqrt((f2 * f2) + (f3 * f3))) / 1000.0f;
        if (fSqrt >= 0.1f) {
            float f4 = fSqrt * 0.02f;
            ...
            this.moveParam.setToValue(this.screenCenterX - (this.velocityX * f4), this.screenCenterY - (this.velocityY * f4));
    ...
    public void doAnimation(Object obj) {
        ...
        gLMapState.screenToP20Point((this.screenCenterX + curXValue) - this.lastMoveX, (this.screenCenterY + curYValue) - this.lastMoveY, iPointObtain);
