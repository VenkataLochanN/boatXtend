...
public class BeeError {
    ...
    public static String parseError(int i) {
        return i != 0 ? i != 1 ? i != 16 ? i != 48 ? i != 32 ? i != 33 ? "Unknown" : "Connect device failed" : "Device disconnected" : "Parameter invalid" : "Service not initialized" : "Error" : HistoryTraceConstant.LBS_HISTORY_TRACE_MESSAGE_SUCCESS;
    }
}