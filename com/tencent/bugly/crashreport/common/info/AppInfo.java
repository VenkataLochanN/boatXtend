...
public class AppInfo {
    ...
    private static ActivityManager f5410a;

    static {
        "@buglyAllChannel@".split(com.amazon.identity.auth.device.dataobject.AppInfo.DELIM);
        "@buglyAllChannelPriority@".split(com.amazon.identity.auth.device.dataobject.AppInfo.DELIM);
    }
    ...
    public static List<String> a(Map<String, String> map) {
        ...
        try {
            ...
            if (str != null && str.length() != 0) {
                String[] strArrSplit = str.split(com.amazon.identity.auth.device.dataobject.AppInfo.DELIM);
    ...
    public static boolean e(Context context) {
        ...
        if (f5410a == null) {
            f5410a = (ActivityManager) context.getSystemService("activity");
        }
        try {
            ActivityManager.MemoryInfo memoryInfo = new ActivityManager.MemoryInfo();
            f5410a.getMemoryInfo(memoryInfo);
