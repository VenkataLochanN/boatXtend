...
public final class LocationClientOption {
    ...
    /* JADX INFO: renamed from: com.baidu.location.LocationClientOption$1, reason: invalid class name */
    /* synthetic */ class AnonymousClass1 {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f2045a = new int[LocationMode.values().length];

        static {
            try {
                f2045a[LocationMode.Hight_Accuracy.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f2045a[LocationMode.Battery_Saving.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2045a[LocationMode.Device_Sensors.ordinal()] = 3;
    ...
    public LocationClientOption(LocationClientOption locationClientOption) {
        ...
        this.f2044a = locationClientOption.f2044a;
    ...
    public void setLocationMode(LocationMode locationMode) {
        int i = AnonymousClass1.f2045a[locationMode.ordinal()];
        if (i == 1) {
            this.openGps = true;
            this.priority = 1;
        } else if (i == 2) {
