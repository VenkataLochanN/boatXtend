...
public class f extends Service {
    ...
    LLSInterface f2438a = null;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    LLSInterface f2439b = null;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    LLSInterface f2440c = null;
        ...
        try {
            ...
            if (file2.exists()) {
                ...
                if (randomAccessFile.readBoolean() && randomAccessFile.readBoolean() && (i = randomAccessFile.readInt()) != 0) {
                    ...
                    String strA = k.a(file, "SHA-256");
                    if (strA != null && k.b(strA, str, "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCiP7BS5IjEOzrKGR9/Ww9oSDhdX1ir26VOsYjT1T6tk2XumRpkHRwZbrucDcNnvSB4QsqiEJnvTSRi7YMbh2H9sLMkcvHlMV5jAErNvnuskWfcvf7T2mq7EUZI/Hf4oVZhHV0hQJRFVdTcjWI6q2uaaKM3VMh+roDesiE7CR2biQIDAQAB")) {
                        z = true;
                    }
                }
    ...
    public IBinder onBind(Intent intent) {
        LLSInterface lLSInterface = this.f2440c;
    ...
    public void onCreate() {
        ...
        this.f2439b = new com.baidu.location.f.a();
        try {
            ...
            if (file2.exists()) {
                if (a(new File(k.j() + File.separator + "app.jar"))) {
                    this.f2438a = (LLSInterface) new DexClassLoader(k.j() + File.separator + "app.jar", k.j(), null, getClassLoader()).loadClass("com.baidu.serverLoc.LocationService").newInstance();
                }
            }
        } catch (Exception unused) {
            this.f2438a = null;
        }
        LLSInterface lLSInterface = this.f2438a;
        if (lLSInterface == null || lLSInterface.getVersion() < this.f2439b.getVersion()) {
            this.f2440c = this.f2439b;
            this.f2438a = null;
        } else {
            this.f2440c = this.f2438a;
            this.f2439b = null;
        }
        isServing = true;
        this.f2440c.onCreate(this);
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        return this.f2440c.onStartCommand(intent, i, i2);
    }
