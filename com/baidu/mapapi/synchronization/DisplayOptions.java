...
public final class DisplayOptions {
    ...
    private static final String f3309a = DisplayOptions.class.getSimpleName();
    private View A;
    private View B;
    private View C;
    private boolean Q;
    ...
    private BitmapDescriptor f3310b = BitmapDescriptorFactory.fromAssetWithDpi("SDK_Default_Icon_Start.png");
    ...
    private BitmapDescriptor f3314f = BitmapDescriptorFactory.fromAssetWithDpi("SDK_Default_Icon_End.png");
    ...
    public DisplayOptions setMapViewPadding(int i, int i2, int i3, int i4) {
        if (i < 0 || i3 < 0 || i2 < 0 || i4 < 0) {
            com.baidu.mapsdkplatform.comapi.synchronization.d.a.b(f3309a, "Padding param is invalid. paddingLeft = " + i + "; paddingRight = " + i3 + "; paddingTop = " + i2 + "; paddingBottom = " + i4);
        }
        if (i < 0) {
            i = 30;
        }
  ...
  0x0003: PHI (r0v2 int) = (r0v0 int), (r0v1 int) binds: [B:3:0x0001, B:6:0x0008] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public com.baidu.mapapi.synchronization.DisplayOptions setRouteLineWidth(int r2) {
        /*
            r1 = this;
            r0 = 5
            if (r2 >= r0) goto L6
        ...
        Ld:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.mapapi.synchronization.DisplayOptions.setRouteLineWidth(int):com.baidu.mapapi.synchronization.DisplayOptions");
    }
