...
public final class SynchronizationConstants {
    ...
    public static final int LBS_ERROR_QUERY_TRACK_DRIVER_POSITION_FAILED = 2004;
    ...
    public static final String LBS_STATUS_MESSAGE_QUERY_TRACK_DRIVER_POSITION_FAILED = "Query track driver position failed.";
