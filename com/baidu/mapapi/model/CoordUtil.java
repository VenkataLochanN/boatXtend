...
public class CoordUtil {
    ...
    public static LatLng decodeLocation(String str) {
        ...
        LatLng latLngA = com.baidu.mapsdkplatform.comapi.util.b.a(str);
        return coordType == coordType2 ? CoordTrans.baiduToGcj(latLngA) : latLngA;
    }
    ...
    public static LatLng decodeNodeLocation(String str) {
        CoordType coordType = SDKInitializer.getCoordType();
        CoordType coordType2 = CoordType.GCJ02;
        LatLng latLngB = com.baidu.mapsdkplatform.comapi.util.b.b(str);
        return coordType == coordType2 ? CoordTrans.baiduToGcj(latLngB) : latLngB;
    }
    ...
    public static LatLng mc2ll(GeoPoint geoPoint) {
        CoordType coordType = SDKInitializer.getCoordType();
        CoordType coordType2 = CoordType.GCJ02;
        LatLng latLngA = com.baidu.mapsdkplatform.comapi.util.b.a(geoPoint);
        return coordType == coordType2 ? CoordTrans.baiduToGcj(latLngA) : latLngA;
    }
}