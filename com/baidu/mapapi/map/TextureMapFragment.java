...
public class TextureMapFragment extends Fragment {
    ...
    private static final String f2988a = TextureMapFragment.class.getSimpleName();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private TextureMapView f2989b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private BaiduMapOptions f2990c;

    public TextureMapFragment() {
    }

    private TextureMapFragment(BaiduMapOptions baiduMapOptions) {
        this.f2990c = baiduMapOptions;
    }
    ...
    public BaiduMap getBaiduMap() {
        TextureMapView textureMapView = this.f2989b;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.f2989b = new TextureMapView(getActivity(), this.f2990c);
        return this.f2989b;
    }
