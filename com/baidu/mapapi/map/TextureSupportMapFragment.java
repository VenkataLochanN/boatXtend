...
public class TextureSupportMapFragment extends Fragment {
    ...
    private static final String f2999a = TextureSupportMapFragment.class.getSimpleName();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private TextureMapView f3000b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private BaiduMapOptions f3001c;

    public TextureSupportMapFragment() {
    }

    private TextureSupportMapFragment(BaiduMapOptions baiduMapOptions) {
        this.f3001c = baiduMapOptions;
    }
    ...
    public BaiduMap getBaiduMap() {
        TextureMapView textureMapView = this.f3000b;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.f3000b = new TextureMapView(getActivity(), this.f3001c);
        return this.f3000b;
    }
