...
public class b {
    ...
    public static int a(LatLng latLng, int i) {
        ...
        GeoPoint geoPointA = a(latLng);
        GeoPoint geoPointA2 = a(latLng2);
        return (int) Math.sqrt(Math.pow(geoPointA.getLatitudeE6() - geoPointA2.getLatitudeE6(), 2.0d) + Math.pow(geoPointA.getLongitudeE6() - geoPointA2.getLongitudeE6(), 2.0d));
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:13:0x0055 A[PHI: r7
  0x0055: PHI (r7v3 double) = (r7v2 double), (r7v0 double) binds: [B:17:0x0067, B:12:0x0053] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:14:0x0058  */
    /* JADX WARN: Removed duplicated region for block: B:16:0x005e  */
    /* JADX WARN: Removed duplicated region for block: B:21:0x0070  */
    /* JADX WARN: Removed duplicated region for block: B:22:0x0073  */
    /* JADX WARN: Removed duplicated region for block: B:28:0x0083  */
    /* JADX WARN: Removed duplicated region for block: B:34:0x0099 A[EDGE_INSN: B:34:0x0099->B:32:0x0099 BREAK  A[LOOP:0: B:26:0x0080->B:31:0x0096], SYNTHETIC] */
    /*
    ...
    */
    public static com.baidu.mapapi.model.LatLng a(com.baidu.mapapi.model.inner.GeoPoint r11) {
        ...
        L80:
            r2 = 6
            if (r1 >= r2) goto L99
            double r2 = r11.f3831b
            double r2 = java.lang.Math.abs(r2)
            double[] r4 = com.baidu.mapsdkplatform.comapi.util.b.f3826a
            r5 = r4[r1]
            int r2 = (r2 > r5 ? 1 : (r2 == r5 ? 0 : -1))
            if (r2 <= 0) goto L96
            double[][] r0 = com.baidu.mapsdkplatform.comapi.util.b.f3828c
            r0 = r0[r1]
            goto L99
        L96:
            int r1 = r1 + 1
            goto L80
        L99:
            com.baidu.mapsdkplatform.comapi.util.b$a r11 = a(r11, r0)
            com.baidu.mapapi.model.LatLng r0 = new com.baidu.mapapi.model.LatLng
            double r1 = r11.f3831b
            double r3 = r11.f3830a
            r0.<init>(r1, r3)
            return r0
        */
    ...
    public static GeoPoint a(LatLng latLng) {
        ...
        aVar.f3831b = Math.abs(latLng.latitude * 1000000.0d);
        if (aVar.f3831b < 0.1d) {
            aVar.f3831b = 0.1d;
        }
        int i = 0;
        while (true) {
            ...
            if (aVar.f3831b > f3827b[i]) {
                dArr = f3829d[i];
                break;
            }
            i++;
        }
        aVar.f3830a = latLng.longitude;
        aVar.f3831b = latLng.latitude;
        a aVarA = a(aVar, dArr);
        return new GeoPoint(aVarA.f3831b, aVarA.f3830a);
    }

    static a a(a aVar, double[] dArr) {
        a aVar2 = new a();
        aVar2.f3830a = dArr[0] + (dArr[1] * Math.abs(aVar.f3830a));
        double dAbs = Math.abs(aVar.f3831b) / dArr[9];
        aVar2.f3831b = dArr[2] + (dArr[3] * dAbs) + (dArr[4] * dAbs * dAbs) + (dArr[5] * dAbs * dAbs * dAbs) + (dArr[6] * dAbs * dAbs * dAbs * dAbs) + (dArr[7] * dAbs * dAbs * dAbs * dAbs * dAbs) + (dArr[8] * dAbs * dAbs * dAbs * dAbs * dAbs * dAbs);
        aVar2.f3830a *= (double) (aVar.f3830a < 0.0d ? -1 : 1);
        aVar2.f3831b *= (double) (aVar.f3831b < 0.0d ? -1 : 1);
        return aVar2;
    }
    ...
    public static List<LatLng> c(String str) {
        ...
        if (aVarA == null || aVarA.f3091d == null) {
            return null;
        }
        ArrayList<ArrayList<Point>> arrayList2 = aVarA.f3091d;
        if (arrayList2.size() > 0) {
            ArrayList<Point> arrayList3 = arrayList2.get(0);
            for (int i = 0; i < arrayList3.size(); i++) {
                Point point = arrayList3.get(i);
                arrayList.add(SDKInitializer.getCoordType() == CoordType.GCJ02 ? CoordTrans.baiduToGcj(a(new GeoPoint(point.y / 100, point.x / 100))) : a(new GeoPoint(point.y / 100, point.x / 100)));
            }
        }
        return arrayList;
    }
    ...
    public static List<List<LatLng>> d(String str) {
        ...
        ArrayList<ArrayList<Point>> arrayList = aVarA.f3091d;
        ArrayList arrayList2 = new ArrayList();
        for (ArrayList<Point> arrayList3 : arrayList) {
            ArrayList arrayList4 = new ArrayList();
            for (Point point : arrayList3) {
                arrayList4.add(SDKInitializer.getCoordType() == CoordType.GCJ02 ? CoordTrans.baiduToGcj(a(new GeoPoint(point.y / 100, point.x / 100))) : a(new GeoPoint(point.y / 100, point.x / 100)));
            }
