...
public class LunarCalendar {
    ...
    private static final int[] DAYS_BEFORE_MONTH = {0, 31, 59, 90, 120, 151, 181, 212, 243, DfuException.ERROR_READ_IMAGE_VERSION_FAILED, 304, b.m1, 365};
    ...
    public static final int[] lunarToSolar(int i, int i2, int i3, boolean z) {
        ...
        for (int i6 = 1; i6 < i2; i6++) {
            i5 = ((524288 >> (i6 + (-1))) & LUNAR_INFO[i4]) == 0 ? i5 + 29 : i5 + 30;
        }
        int i7 = i5 + i3;
        int i8 = (LUNAR_INFO[i4] & 15728640) >> 20;
        if (i8 != 0 && (i2 > i8 || (i2 == i8 && z))) {
            i7 = ((524288 >> (i2 - 1)) & LUNAR_INFO[i4]) == 0 ? i7 + 29 : i7 + 30;
        }
        if (i7 > 366 || (i % 4 != 0 && i7 > 365)) {
            i++;
            i7 = i % 4 == 1 ? i7 - 366 : i7 - 365;
        }
        int[] iArr2 = new int[3];
        int i9 = 1;
        while (true) {
    ...
    public static final int[] solarToLunar(int i, int i2, int i3) {
        ...
        int i6 = solar_1_1[i5];
        long jSolarToInt = solarToInt(i, i2, i3) - solarToInt(getBitInt(i6, 12, 9), getBitInt(i6, 4, 5), getBitInt(i6, 5, 0));
        int i7 = lunar_month_days[i5];
        int bitInt = getBitInt(i7, 4, 13);
        int i8 = i5 + solar_1_1[0];
        long j = jSolarToInt + 1;
        int i9 = 1;
        for (int i10 = 0; i10 < 13; i10++) {
            long j2 = getBitInt(i7, 1, 12 - i10) == 1 ? 30 : 29;
            if (j <= j2) {
                break;
            }
            i9++;
    ...
    public static final int[] solarToLunarDeprecated(int i, int i2, int i3) {
        ...
        int i4 = 1900;
        int i5 = 0;
        int time = (int) ((new GregorianCalendar(i, i2 - 1, i3).getTime().getTime() - new GregorianCalendar(1900, 0, 31).getTime().getTime()) / DateUtil.DAY);
        ...
        int i7 = 1;
        while (i7 <= 13 && i6 > 0) {
            iDaysInLunarMonth = daysInLunarMonth(i4, i7);
            i6 -= iDaysInLunarMonth;
            i7++;
        }
        if (iLeapMonth != 0 && i7 > iLeapMonth) {
            i7--;
            Log.i("----------->", i + "-" + i2 + "-" + i3 + "====>" + i7 + "-" + iLeapMonth);
            if (i7 == iLeapMonth) {
                i5 = 1;
            }
        }
    ...
    public static final int daysInMonth(int i, int i2, boolean z) {
        int iLeapMonth = leapMonth(i);
        int i3 = (iLeapMonth == 0 || i2 <= iLeapMonth) ? 0 : 1;
        if (!z) {
            return daysInLunarMonth(i, i2 + i3);
        }
        if (iLeapMonth == 0 || iLeapMonth != i2) {
            return 0;
        }
