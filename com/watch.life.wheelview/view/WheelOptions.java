...
import com.watch.life.wheelview.listener.OnOptionsSelectChangeListener;
...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> list, List<List<T>> list2, List<List<List<T>>> list3) {
        ...
        this.wheelListener_option1 = new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelOptions.1
        ...
        this.wheelListener_option2 = new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelOptions.2
            @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
            public void onItemSelected(int i) {
                int size = 0;
                if (WheelOptions.this.mOptions3Items != null) {
        ...
        this.wv_option3.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelOptions.3
            @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
            public void onItemSelected(int i) {
    ...
    public void setNPicker(List<T> list, List<T> list2, List<T> list3) {
        ...
        if (this.optionsSelectChangeListener != null) {
            this.wv_option1.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelOptions.4
                @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
                public void onItemSelected(int i) {
        ...
        if (list2 == null) {
            ...
            this.wv_option2.setVisibility(0);
            if (this.optionsSelectChangeListener != null) {
                this.wv_option2.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelOptions.5
                    @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
                    public void onItemSelected(int i) {
        ...
        this.wv_option3.setVisibility(0);
        if (this.optionsSelectChangeListener != null) {
            this.wv_option3.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelOptions.6
                @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
                public void onItemSelected(int i) {
                    WheelOptions.this.optionsSelectChangeListener.onOptionsSelectChanged(WheelOptions.this.wv_option1.getCurrentItem(), WheelOptions.this.wv_option2.getCurrentItem(), i);
                }
