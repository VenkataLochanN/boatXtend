...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initWheelTime(LinearLayout linearLayout) {
        ...
        if (this.mPickerOptions.timeSelectChangeListener != null) {
            this.wheelTime.setSelectChangeCallback(new ISelectTimeCallback() { // from class: com.watch.life.wheelview.view.TimePickerView.1
                @Override // com.watch.life.wheelview.listener.ISelectTimeCallback
    ...
    @Override // com.watch.life.wheelview.view.BasePickerView
