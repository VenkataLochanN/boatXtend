...
import com.watch.life.wheelview.listener.ISelectTimeCallback;
import com.watch.life.wheelview.listener.OnItemSelectedListener;
import com.watch.life.wheelview.utils.ChinaDate;
import com.watch.life.wheelview.utils.LunarCalendar;
...
public class WheelTime {
    ...
    private void setLunar(int i, int i2, int i3, boolean z, int i4, int i5, int i6) {
        ...
        this.wv_year.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelTime.1
        ...
        this.wv_month.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelTime.2
            @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
            public void onItemSelected(int i7) {
                int iMonthDays;
    ...
    private void setSolar(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        this.wv_seconds.setGravity(this.gravity);
        this.wv_year.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelTime.3
            @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
        ...
        this.wv_month.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelTime.4
            @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
            public void onItemSelected(int i13) {
                int i14 = i13 + 1;
                if (WheelTime.this.startYear == WheelTime.this.endYear) {
    ...
    private void setChangedListener(WheelView wheelView) {
        if (this.mSelectChangeCallback != null) {
            wheelView.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.watch.life.wheelview.view.WheelTime.5
                @Override // com.watch.life.wheelview.listener.OnItemSelectedListener
