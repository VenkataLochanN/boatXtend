...
import com.watch.life.wheelview.configure.PickerOptions;
import com.watch.life.wheelview.listener.OnDismissListener;
import com.watch.life.wheelview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    private View.OnKeyListener onKeyBackListener = new View.OnKeyListener() { // from class: com.watch.life.wheelview.view.BasePickerView.4
    ...
    private final View.OnTouchListener onCancelableTouchListener = new View.OnTouchListener() { // from class: com.watch.life.wheelview.view.BasePickerView.5
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            this.dialogView = (ViewGroup) layoutInflaterFrom.inflate(R.layout.layout_basepickerview, (ViewGroup) null, false);
            ...
            createDialog();
            this.dialogView.setOnClickListener(new View.OnClickListener() { // from class: com.watch.life.wheelview.view.BasePickerView.1
            ...
            this.rootView = (ViewGroup) layoutInflaterFrom.inflate(R.layout.layout_basepickerview, this.mPickerOptions.decorView, false);
    ...
    public void dismiss() {
        ...
        if (this.isAnim) {
            this.outAnim.setAnimationListener(new Animation.AnimationListener() { // from class: com.watch.life.wheelview.view.BasePickerView.2
    ...
    public void dismissImmediately() {
        this.mPickerOptions.decorView.post(new Runnable() { // from class: com.watch.life.wheelview.view.BasePickerView.3
    ...
    public void createDialog() {
        if (this.dialogView != null) {
            ...
            this.mDialog.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.watch.life.wheelview.view.BasePickerView.6
