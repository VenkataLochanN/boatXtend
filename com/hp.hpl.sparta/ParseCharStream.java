...
class ParseCharStream implements ParseSource {
    ...
    private static final char[] NAME_PUNCT_CHARS = {FilenameUtils.EXTENSION_SEPARATOR, '-', '_', ':'};
    ...
    public ParseCharStream(String str, Reader reader, char[] cArr, ParseLog parseLog, String str2, ParseHandler parseHandler) throws ParseException, IOException {
        ...
        if (str3 != null && !str3.equals(element.getTagName())) {
            this.log_.warning("DOCTYPE name \"" + this.docTypeName_ + "\" not same as tag name, \"" + element.getTagName() + "\" of root element", this.systemId_, getLineNumber());
        }
        while (isMisc()) {
            readMisc();
        }
    ...
    private final void readChar(char c2) throws ParseException, IOException {
        char c3 = readChar();
        if (c3 != c2) {
            throw new ParseException(this, c3, c2);
        }
    }
    ...
    private final char readChar(char c2, char c3) throws ParseException, IOException {
        ...
        throw new ParseException(this, c4, new char[]{c2, c3});
    }
    ...
    private final char readChar(char c2, char c3, char c4, char c5) throws ParseException, IOException {
        ...
        throw new ParseException(this, c6, new char[]{c2, c3, c4, c5});
    }
    ...
    static {
        ...
        VERSIONNUM_PUNC_CHARS = new char[]{'_', FilenameUtils.EXTENSION_SEPARATOR, ':', '-'};
    ...
    private char readNameStartChar() throws ParseException, IOException {
        char c2 = readChar();
        if (isLetter(c2) || c2 == '_' || c2 == ':') {
            return c2;
        }
        throw new ParseException(this, c2, "letter, underscore, colon");
    }

    private final String readEntityValue() throws ParseException, IOException {
        char c2 = readChar('\'', Typography.quote);
